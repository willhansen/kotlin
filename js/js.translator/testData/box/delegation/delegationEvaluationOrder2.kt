...
class Base2Impl(konst s: String) : Base2 {
...
fun box(): String {
    var d = Derived()
    assertEquals(":DerivedBase:newBase:newBase2:Derived", global, "ekonstuation order 1")

    global = ""
    var d1 = Derived1()
    assertEquals(":DerivedBase:newBase:newBase2:Derived", global, "ekonstuation order 2")

    global = ""
    var d2 = Derived2()
    assertEquals(":DerivedBase:newBase:newBase2:Derived", global, "ekonstuation order 3")
