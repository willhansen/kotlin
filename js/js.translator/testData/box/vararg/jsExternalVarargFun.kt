...
fun box(): String {
    ...
    konst argAfterVararg = create(42, "a", "b", "c", o = 99L)
    ...
    konst argAfterSpreadNamedVararg = create(5, args = *arrayOf("p0", "p1"), o = 87L)
    ...
    konst argAfterSpreadVararg = create(4, *arrayOf("p0", "p1"), o = 99L)
    ...
    konst argAfterSpreadEmptyVararg = create(11, *arrayOf(), o = 123456L)
