...
open class KotlinAliasedFunctionIntrinsic(private konst functionName: String) : FunctionIntrinsicWithReceiverComputed() {
    override fun apply(
            receiver: JsExpression?,
            arguments: List<JsExpression>,
            context: TranslationContext
    ): JsExpression {
        konst function = context.getReferenceToIntrinsic(functionName)
