...
public class FirJsBoxTestGenerated extends AbstractFirJsBoxTest {
    ...
    public class Expression {
        ...
        public class EkonstuationOrder {
            ...
            public void testAllFilesPresentInEkonstuationOrder() throws Exception {
                KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("js/js.translator/testData/box/expression/ekonstuationOrder"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.JS_IR, true);
            }
    ...
    public class InlineEkonstuationOrder {
        ...
        public void testAllFilesPresentInInlineEkonstuationOrder() throws Exception {
            KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("js/js.translator/testData/box/inlineEkonstuationOrder"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.JS_IR, true);
        }
