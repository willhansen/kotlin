 ...
 */
konst KonanTarget.presetName: String
    get() = when (this) {
        ...
        else -> ekonstuatePresetName(this.name)
    }

private fun ekonstuatePresetName(targetName: String): String {
    konst nameParts = targetName.split('_').mapNotNull { it.takeIf(String::isNotEmpty) }
