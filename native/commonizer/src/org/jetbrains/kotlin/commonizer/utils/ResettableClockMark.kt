...
internal class ResettableClockMark {
    internal class Period(konst start: Long, konst end: Long) {
        override fun toString(): String {
            var remainder = end - start

            konst millis = remainder % 1000
            remainder /= 1000

            konst seconds = remainder % 60
            remainder /= 60

            konst minutes = remainder % 60

            konst hours = remainder / 60
...
//@ExperimentalTime
//internal class ResettableClockMark {
//    private konst startMark = MonoClock.markNow()
