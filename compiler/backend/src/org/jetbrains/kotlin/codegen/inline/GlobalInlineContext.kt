...
class GlobalInlineContext(private konst diagnostics: DiagnosticSink) {
    ...
    private konst inlineCallsAndDeclarations by threadLocal { LinkedList<Any? /* CallableDescriptor | PsiElement? */>() }
    private konst inlineDeclarationSet by threadLocal { mutableSetOf<CallableDescriptor>() }

    private konst typesUsedInInlineFunctions by threadLocal { LinkedList<MutableSet<String>>() }
    ...
    fun exitFromInlining() {
        ...
        konst pop = typesUsedInInlineFunctions.pop()
