...
object FirNamedVarargChecker : FirCallChecker() {
    override fun check(expression: FirCall, context: CheckerContext, reporter: DiagnosticReporter) {
        ...
        konst isAnnotation = expression is FirAnnotation
        konst redundantSpreadWarningFactory =
        ...
        konst allowAssignArray = context.session.languageVersionSettings.supportsFeature(
        ...
        fun checkArgument(argument: FirExpression, isVararg: Boolean, expectedArrayType: ConeKotlinType?) {
            ...
            konst typeRef = argument.expression.typeRef
        ...
        if (expression is FirArrayOfCall) {
            ...
            konst argumentMap = expression.resolvedArgumentMapping ?: return
