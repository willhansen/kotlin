...
object FirMemberFunctionsChecker : FirSimpleFunctionChecker() {
    override fun check(declaration: FirSimpleFunction, context: CheckerContext, reporter: DiagnosticReporter) {
        konst containingDeclaration = context.containingDeclarations.lastIsInstanceOrNull<FirClass>() ?: return
    ...
    private fun checkFunction(
        ...
        konst source = function.source ?: return
        ...
        konst isAbstract = function.isAbstract || hasAbstractModifier
        if (isAbstract) {
        ...
        konst isInsideExpectClass = isInsideExpectClass(containingDeclaration, context)
        konst isInsideExternal = isInsideExternalClass(containingDeclaration, context)
