...
sealed class FirVariable : FirCallableDeclaration(), FirStatement {
    ...
    abstract override konst symbol: FirVariableSymbol<out FirVariable>
    abstract konst initializer: FirExpression?
    abstract konst delegate: FirExpression?
    abstract konst isVar: Boolean
    abstract konst isVal: Boolean
    abstract konst getter: FirPropertyAccessor?
    abstract konst setter: FirPropertyAccessor?
    abstract konst backingField: FirBackingField?
