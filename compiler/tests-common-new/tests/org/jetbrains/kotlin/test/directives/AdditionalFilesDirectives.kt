...
object AdditionalFilesDirectives : SimpleDirectivesContainer() {
    ...
    konst WITH_COROUTINES by directive(
        description = """
    ...
    konst CHECK_STATE_MACHINE by directive(
        description = """
    ...
    konst CHECK_TAIL_CALL_OPTIMIZATION by directive(
        description = """
    ...
    konst SPEC_HELPERS by directive(
        description = """
    ...
    konst INFERENCE_HELPERS by directive(
        description = """
            Adds util functions for type checking
