...
@JvmField
konst JVM_THROWS_ANNOTATION_FQ_NAME = FqName("kotlin.jvm.Throws")

konst KOTLIN_THROWS_ANNOTATION_FQ_NAME = FqName("kotlin.Throws")

konst KOTLIN_NATIVE_THROWS_ANNOTATION_FQ_NAME = FqName("kotlin.native.Throws")
