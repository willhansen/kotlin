...
data class SingleType(konst targetType: KotlinType) : TypePredicate {
...
data class AllSubtypes(konst upperBound: KotlinType) : TypePredicate {
...
data class ForAllTypes(konst typeSets: List<TypePredicate>) : TypePredicate {
...
data class ForSomeType(konst typeSets: List<TypePredicate>) : TypePredicate {
