...
object InternalFlexibleTypeTransformer : TypeTransformerForTests() {
    ...
    // This is used in tests and Ekonstuate Expression to have flexible types in the code,
    // but normal users should not be referencing this classifier
    @JvmField
    konst FLEXIBLE_TYPE_CLASSIFIER: ClassId = ClassId.topLevel(FqName("kotlin.internal.flexible.ft"))
