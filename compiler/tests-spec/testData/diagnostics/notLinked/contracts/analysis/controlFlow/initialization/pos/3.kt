 ...
 * NUMBER: 3
 * DESCRIPTION: konst/var assignments or subsequent usages with compelx control flow inside/outside lambda of contract function with CallsInPlace effect
...
fun case_1(konstue_1: EnumClass?) {
    ...
    <!DEBUG_INFO_IMPLICIT_EXHAUSTIVE!>when (konstue_1) {
