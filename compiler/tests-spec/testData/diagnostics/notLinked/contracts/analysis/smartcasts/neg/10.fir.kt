...
fun case_1(konstue_1: Any?) {
    if (!contracts.case_1(konstue_1)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>toByte<!>())
}

// TESTCASE NUMBER: 2
fun case_2(konstue_1: Any?) {
    if (!contracts.case_2(konstue_1)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1?.<!UNRESOLVED_REFERENCE!>toByte<!>())
}
...
fun case_5(konstue_1: Any?) {
    ...
    if (!(funWithReturnsNotNullAndInvertCondition(konstue_1 !is String) != null)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!(funWithReturnsNullAndInvertCondition(konstue_1 !is String) == null)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
}

// TESTCASE NUMBER: 6
fun case_6(konstue_1: Any?) {
    if (!funWithReturnsTrue(konstue_1 == null)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
}

// TESTCASE NUMBER: 7
fun case_7(konstue_1: Any?) {
    if (!funWithReturnsTrueAndInvertCondition(konstue_1 != null)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (funWithReturnsFalse(konstue_1 == null)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (funWithReturnsFalseAndInvertCondition(konstue_1 != null)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
}

// TESTCASE NUMBER: 8
fun case_8(konstue_1: Any?) {
    if (!funWithReturnsTrueAndInvertTypeCheck(konstue_1)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (funWithReturnsFalseAndInvertTypeCheck(konstue_1)) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
}
...
fun case_18(konstue_1: Any?) {
    if (!konstue_1.case_18_1()) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (konstue_1.case_18_2()) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (konstue_1.case_18_3() == null) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (konstue_1.case_18_4() != null) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
}

// TESTCASE NUMBER: 19
fun case_19(konstue_1: Number) {
    when { !konstue_1.case_19_1() -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>inv<!>()) }
    when { konstue_1.case_19_2() -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>inv<!>()) }
    when { konstue_1.case_19_3() == null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>inv<!>()) }
    when { konstue_1.case_19_4() != null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>inv<!>()) }
}
...
fun case_22(konstue_1: Any?, konstue_2: Any?) {
    when { konstue_1.case_22_1() -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>) }
    when { konstue_2.case_22_2() == null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>length<!>) }
    when { konstue_2.case_22_3() != null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>length<!>) }
}

// TESTCASE NUMBER: 23
fun case_23(konstue_1: Number?, konstue_2: Number?) {
    if (konstue_1.case_23_1()) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>inv<!>())
    if (konstue_2.case_23_2() == null) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>())
    if (konstue_2.case_23_3() != null) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>())
}

// TESTCASE NUMBER: 24
fun case_24(konstue_1: Any?, konstue_2: Any?) {
    if (konstue_1.case_24_1()) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_1.<!UNRESOLVED_REFERENCE!>inv<!>())
    if (konstue_2.case_24_2() != null) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>())
    if (konstue_2.case_24_3() == null) <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>())
}
