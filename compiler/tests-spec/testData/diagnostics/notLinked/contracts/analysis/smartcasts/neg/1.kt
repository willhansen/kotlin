...
fun case_2(konstue_1: Int?) {
    ...
    println(konstue_1<!UNSAFE_CALL!>.<!>inc())
...
fun case_8(konstue_1: Any?) {
    ...
    if (funWithReturnsNotNull(konstue_1 is String) == null) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!(funWithReturnsNotNull(konstue_1 is String) != null)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!(funWithReturnsNull(konstue_1 is String) == null)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (funWithReturnsNull(konstue_1 is String) != null) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
}
...
fun case_10(konstue_1: Any?) {
    if (!funWithReturnsTrueAndTypeCheck(konstue_1)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!!funWithReturnsFalseAndTypeCheck(konstue_1)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!(funWithReturnsNotNullAndTypeCheck(konstue_1) != null)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!!(funWithReturnsNotNullAndTypeCheck(konstue_1) == null)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!!(funWithReturnsNullAndTypeCheck(konstue_1) != null)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
    if (!(funWithReturnsNullAndTypeCheck(konstue_1) == null)) println(konstue_1.<!UNRESOLVED_REFERENCE!>length<!>)
}
