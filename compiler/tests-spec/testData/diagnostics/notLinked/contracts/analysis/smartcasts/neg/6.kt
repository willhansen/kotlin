 ...
 * NUMBER: 6
 * DESCRIPTION: Smartcasts using Returns effects with complex (conjunction/disjunction) type checking and not-null conditions on receiver and some konstues (mixed) inside contract.
 */
...
fun case_4(konstue_1: Any?, konstue_2: Number, konstue_3: Any?, konstue_4: String?) {
    ...
    println(konstue_2.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>())
    println(konstue_3.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>toByte<!>())
...
fun case_5(konstue_1: Any?, konstue_2: Int?, konstue_3: Any?, konstue_4: Int?, konstue_5: Any?, konstue_6: Int?) {
    ...
    when {
        konstue_5.case_5_3(konstue_6) != null -> {
            println(konstue_5.<!UNRESOLVED_REFERENCE!>length<!>)
...
fun case_6(konstue_1: Number?, konstue_2: Any?, konstue_3: Number?, konstue_4: Any?, konstue_5: Number?, konstue_6: Any?) {
    ...
    if (!konstue_3.case_6_2(konstue_4)) {
        println(konstue_3.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>())
        println(konstue_4.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>toByte<!>())
    }
    if (konstue_5.case_6_3(konstue_6) != null) {
        println(konstue_5.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>())
        println(konstue_6.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>toByte<!>())
    }
...
fun case_8(konstue_1: Any?, konstue_2: Number, konstue_3: Any?, konstue_4: String?) {
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> println(konstue_2.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>()) }
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> println(konstue_3.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>toByte<!>()) }
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> println(konstue_4<!UNSAFE_CALL!>.<!>length) }
    when { !konstue_1.case_8_2(konstue_2, konstue_3, konstue_4) -> println(konstue_2.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>()) }
    when { !konstue_1.case_8_2(konstue_2, konstue_3, konstue_4) -> println(konstue_3.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>toByte<!>()) }
    when { !konstue_1.case_8_2(konstue_2, konstue_3, konstue_4) -> println(konstue_4<!UNSAFE_CALL!>.<!>length) }
    when { konstue_1.case_8_3(konstue_2, konstue_3, konstue_4) == null -> println(konstue_2.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>()) }
    when { konstue_1.case_8_3(konstue_2, konstue_3, konstue_4) == null -> println(konstue_3.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>toByte<!>()) }
    when { konstue_1.case_8_3(konstue_2, konstue_3, konstue_4) == null -> println(konstue_4<!UNSAFE_CALL!>.<!>length) }
    when { konstue_1.case_8_4(konstue_2, konstue_3, konstue_4) != null -> println(konstue_2.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>inv<!>()) }
    when { konstue_1.case_8_4(konstue_2, konstue_3, konstue_4) != null -> println(konstue_3.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>toByte<!>()) }
