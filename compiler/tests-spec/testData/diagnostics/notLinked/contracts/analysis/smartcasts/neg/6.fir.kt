...
fun <T : Any?> T?.case_7_2(konstue_2: Any?): Boolean {
    contract { returns(false) implies (this@case_7_2 !is Number || this@case_7_2 !is Int || <!SENSELESS_COMPARISON!>this@case_7_2 == null<!> || konstue_2 == null) }
...
fun case_4(konstue_1: Any?, konstue_2: Number, konstue_3: Any?, konstue_4: String?) {
    ...
    <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>())
    <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_3.<!UNRESOLVED_REFERENCE!>toByte<!>())
    println(konstue_4<!UNSAFE_CALL!>.<!>length)
}
...
fun case_5(konstue_1: Any?, konstue_2: Int?, konstue_3: Any?, konstue_4: Int?, konstue_5: Any?, konstue_6: Int?) {
    ...
    when {
        konstue_5.case_5_3(konstue_6) != null -> {
            <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_5.<!UNRESOLVED_REFERENCE!>length<!>)
            println(konstue_6<!UNSAFE_CALL!>.<!>inv())
        }
    }
}
...
fun case_6(konstue_1: Number?, konstue_2: Any?, konstue_3: Number?, konstue_4: Any?, konstue_5: Number?, konstue_6: Any?) {
    ...
    if (!konstue_3.case_6_2(konstue_4)) {
        <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_3.<!UNRESOLVED_REFERENCE!>inv<!>())
        <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_4.<!UNRESOLVED_REFERENCE!>toByte<!>())
    }
    if (konstue_5.case_6_3(konstue_6) != null) {
        <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_5.<!UNRESOLVED_REFERENCE!>inv<!>())
        <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_6.<!UNRESOLVED_REFERENCE!>toByte<!>())
    }
...
fun case_7(konstue_1: Any?, konstue_2: String?, konstue_3: Any?, konstue_4: String?, konstue_5: Any?, konstue_6: String?) {
    ...
    if (konstue_5.case_7_3(konstue_6) != null) {
        <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_5.<!UNRESOLVED_REFERENCE!>inv<!>())
        println(konstue_6<!UNSAFE_CALL!>.<!>length)
    }
...
// TESTCASE NUMBER: 8
fun case_8(konstue_1: Any?, konstue_2: Number, konstue_3: Any?, konstue_4: String?) {
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>()) }
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_3.<!UNRESOLVED_REFERENCE!>toByte<!>()) }
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> println(konstue_4<!UNSAFE_CALL!>.<!>length) }
    when { !konstue_1.case_8_2(konstue_2, konstue_3, konstue_4) -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>()) }
    when { !konstue_1.case_8_2(konstue_2, konstue_3, konstue_4) -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_3.<!UNRESOLVED_REFERENCE!>toByte<!>()) }
    when { !konstue_1.case_8_2(konstue_2, konstue_3, konstue_4) -> println(konstue_4<!UNSAFE_CALL!>.<!>length) }
    when { konstue_1.case_8_3(konstue_2, konstue_3, konstue_4) == null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>()) }
    when { konstue_1.case_8_3(konstue_2, konstue_3, konstue_4) == null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_3.<!UNRESOLVED_REFERENCE!>toByte<!>()) }
    when { konstue_1.case_8_3(konstue_2, konstue_3, konstue_4) == null -> println(konstue_4<!UNSAFE_CALL!>.<!>length) }
    when { konstue_1.case_8_4(konstue_2, konstue_3, konstue_4) != null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_2.<!UNRESOLVED_REFERENCE!>inv<!>()) }
    when { konstue_1.case_8_4(konstue_2, konstue_3, konstue_4) != null -> <!OVERLOAD_RESOLUTION_AMBIGUITY!>println<!>(konstue_3.<!UNRESOLVED_REFERENCE!>toByte<!>()) }
    when { konstue_1.case_8_4(konstue_2, konstue_3, konstue_4) != null -> println(konstue_4<!UNSAFE_CALL!>.<!>length) }
}
