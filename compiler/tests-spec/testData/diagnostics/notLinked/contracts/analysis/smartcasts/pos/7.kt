...
fun case_4(konstue_1: Any?) {
    case_4_1(konstue_1)
    <!DEBUG_INFO_SMARTCAST!>konstue_1<!>?.toByte()
    case_4_2(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>)
    <!DEBUG_INFO_SMARTCAST!>konstue_1<!>.toByte()
    case_4_3(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>)
    <!DEBUG_INFO_SMARTCAST!>konstue_1<!>.inv()
}
...
fun case_5(konstue_1: Int?, konstue_2: Int?) {
    ...
    if (!case_5_3(konstue_2)) {
        <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv()
        if (!case_5_4(konstue_2)) {
            <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.<!UNREACHABLE_CODE!>inv()<!>
            <!UNREACHABLE_CODE!><!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv()<!>
        }
    }
...
fun case_6(konstue_1: Number?, konstue_2: Number?) {
    when {
        case_6_1(konstue_1) -> {
            <!DEBUG_INFO_SMARTCAST!>konstue_1<!>.toByte()
            when { case_6_2(konstue_1) -> <!DEBUG_INFO_SMARTCAST!>konstue_1<!>.inv() }
        }
    }
    when {
        !case_6_3(konstue_2) -> {
            <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.toByte()
            when { !case_6_4(konstue_2) -> <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv() }
        }
    }
    when {
        case_6_5(konstue_2) != null -> {
            <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.toByte()
            when { case_6_6(konstue_2) != null -> <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv() }
        }
    }
    when {
        case_6_7(konstue_2) == null -> {
            <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.toByte()
            when { case_6_8(konstue_2) == null -> <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv() }
        }
    }
}
...
fun case_7(konstue_1: Any?, konstue_2: Any?) {
    ...
    if (!case_7_3(konstue_2)) {
        <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length
        if (!case_7_4(konstue_2)) <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length
    }
    if (case_7_5(konstue_2) != null) {
        <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length
        if (case_7_6(konstue_2) != null) <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length
    }
    if (case_7_7(konstue_2) == null) {
        <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length
        if (case_7_8(konstue_2) == null) <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length
    }
}
...
fun case_8(konstue_1: Any?, konstue_2: Any?) {
    if (case_8_1(konstue_1)) {
        <!DEBUG_INFO_SMARTCAST!>konstue_1<!>?.toByte()
        if (case_8_2(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>)) {
            <!DEBUG_INFO_SMARTCAST!>konstue_1<!>.toByte()
            if (case_8_3(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>)) <!DEBUG_INFO_SMARTCAST!>konstue_1<!>.inv()
        }
    }
    if (!case_8_4(konstue_2)) {
        <!DEBUG_INFO_SMARTCAST!>konstue_2<!>?.toByte()
        if (!case_8_5(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>)) {
            <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.toByte()
            if (!case_8_6(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>)) <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv()
        }
    }
    if (case_8_7(konstue_2) != null) {
        <!DEBUG_INFO_SMARTCAST!>konstue_2<!>?.toByte()
        if (case_8_8(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>) != null) {
            <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.toByte()
            if (case_8_9(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>) != null) <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv()
        }
    }
    if (case_8_10(konstue_2) == null) {
        <!DEBUG_INFO_SMARTCAST!>konstue_2<!>?.toByte()
        if (case_8_11(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>) == null) {
            <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.toByte()
            if (case_8_12(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>) == null) <!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv()
        }
    }
}
