...
fun case_3(konstue_1: Any?, konstue_2: String?) {
    ...
    println(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>.inv())
    println(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length)
}
...
fun case_4(konstue_1: Any?, konstue_2: Number, konstue_3: Any?, konstue_4: String?) {
    ...
    println(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv())
    println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.toByte())
    println(<!DEBUG_INFO_SMARTCAST!>konstue_4<!>.length)
}
...
fun case_5(konstue_1: Any?, konstue_2: Int?, konstue_3: Any?, konstue_4: Int?, konstue_5: Any?, konstue_6: Int?) {
    ...
    when {
        !konstue_3.case_5_2(konstue_4) -> {
            ...
            println(<!DEBUG_INFO_SMARTCAST!>konstue_4<!>.inv())
        }
    }
    when {
        konstue_5.case_5_3(konstue_6) != null -> {
            println(<!DEBUG_INFO_SMARTCAST!>konstue_5<!>.length)
            println(<!DEBUG_INFO_SMARTCAST!>konstue_6<!>.inv())
        }
    }
    when {
...
fun case_6(konstue_1: Number?, konstue_2: Any?, konstue_3: Number?, konstue_4: Any?, konstue_5: Number?, konstue_6: Any?) {
    ...
    if (!konstue_3.case_6_2(konstue_4)) {
        println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.inv())
        println(<!DEBUG_INFO_SMARTCAST!>konstue_4<!>.toByte())
    }
    if (konstue_5.case_6_3(konstue_6) != null) {
        println(<!DEBUG_INFO_SMARTCAST!>konstue_5<!>.inv())
        println(<!DEBUG_INFO_SMARTCAST!>konstue_6<!>.toByte())
    }
...
fun case_7(konstue_1: Any?, konstue_2: String?, konstue_3: Any?, konstue_4: String?, konstue_5: Any?, konstue_6: String?) {
    ...
    if (konstue_5.case_7_3(konstue_6) != null) {
        println(<!DEBUG_INFO_SMARTCAST!>konstue_5<!>.inv())
        println(<!DEBUG_INFO_SMARTCAST!>konstue_6<!>.length)
    }
...
fun case_8(konstue_1: Any?, konstue_2: Number, konstue_3: Any?, konstue_4: String?, konstue_5: Any?, konstue_6: Number, konstue_7: Any?, konstue_8: String?) {
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> println(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv()) }
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.toByte()) }
    when { konstue_1.case_8_1(konstue_2, konstue_3, konstue_4) -> println(<!DEBUG_INFO_SMARTCAST!>konstue_4<!>.length) }
    when { !konstue_5.case_8_2(konstue_6, konstue_7, konstue_8) -> println(<!DEBUG_INFO_SMARTCAST!>konstue_6<!>.inv()) }
    when { !konstue_5.case_8_2(konstue_6, konstue_7, konstue_8) -> println(<!DEBUG_INFO_SMARTCAST!>konstue_7<!>.toByte()) }
    when { !konstue_5.case_8_2(konstue_6, konstue_7, konstue_8) -> println(<!DEBUG_INFO_SMARTCAST!>konstue_8<!>.length) }
    when { konstue_5.case_8_3(konstue_6, konstue_7, konstue_8) != null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_6<!>.inv()) }
    when { konstue_5.case_8_3(konstue_6, konstue_7, konstue_8) != null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_7<!>.toByte()) }
    when { konstue_5.case_8_3(konstue_6, konstue_7, konstue_8) != null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_8<!>.length) }
    when { konstue_5.case_8_4(konstue_6, konstue_7, konstue_8) == null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_6<!>.inv()) }
    when { konstue_5.case_8_4(konstue_6, konstue_7, konstue_8) == null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_7<!>.toByte()) }
    when { konstue_5.case_8_4(konstue_6, konstue_7, konstue_8) == null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_8<!>.length) }
}
