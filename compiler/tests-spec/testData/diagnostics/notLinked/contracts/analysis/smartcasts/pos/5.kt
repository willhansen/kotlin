...
fun case_4(konstue_1: Any?, konstue_2: Any?, konstue_3: Any?) {
    when { konstue_1.case_4_1() -> println(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>.length) }
    when { !konstue_2.case_4_2() -> println(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>.length) }
    when { konstue_3.case_4_3() != null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.length) }
    when { konstue_3.case_4_4() == null -> println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.length) }
}

// TESTCASE NUMBER: 5
fun case_5(konstue_1: Number?, konstue_2: Number?, konstue_3: Number?) {
    if (konstue_1.case_5_1()) println(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>.inv())
    if (!konstue_2.case_5_2()) println(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv())
    if (konstue_3.case_5_3() != null) println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.inv())
    if (konstue_3.case_5_4() == null) println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.inv())
}

// TESTCASE NUMBER: 6
fun case_6(konstue_1: Any?, konstue_2: Any?, konstue_3: Any?) {
    if (konstue_1.case_6_1()) println(<!DEBUG_INFO_SMARTCAST!>konstue_1<!>.inv())
    if (!konstue_2.case_6_2()) println(<!DEBUG_INFO_SMARTCAST!>konstue_2<!>.inv())
    if (konstue_3.case_6_3() != null) println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.inv())
    if (konstue_3.case_6_4() == null) println(<!DEBUG_INFO_SMARTCAST!>konstue_3<!>.inv())
}
