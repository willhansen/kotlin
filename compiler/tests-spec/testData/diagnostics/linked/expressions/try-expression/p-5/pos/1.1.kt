 ...
 * NUMBER: 1
 * DESCRIPTION: If no exception is thrown during the ekonstuation of the try body, no catch blocks are executed, the finally block is ekonstuated after the try body, and the program execution continues as normal.
 */
