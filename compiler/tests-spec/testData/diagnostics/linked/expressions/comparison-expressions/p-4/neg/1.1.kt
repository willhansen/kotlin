...
fun case1() {
    ...
    konst x0 = a3 <!COMPARE_TO_TYPE_MISMATCH!>><!> a4
    konst x1 = a3 <!COMPARE_TO_TYPE_MISMATCH!><<!> a4
    konst x2 = a3 <!COMPARE_TO_TYPE_MISMATCH!>>=<!> a4
    konst x3 = a3 <!COMPARE_TO_TYPE_MISMATCH!><=<!> a4
}
