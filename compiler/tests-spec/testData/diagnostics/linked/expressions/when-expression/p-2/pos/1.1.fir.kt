...
fun case_5(konstue_1: Int, konstue_2: Int, konstue_3: Boolean?) {
    when {
        ...
        konstue_1 == 5 -> <!NO_ELSE_IN_WHEN!>when<!> (konstue_3) {
            true -> "1"
            false -> "2"
        }
        konstue_1 == 6 -> <!NO_ELSE_IN_WHEN!>when<!> (konstue_3) {}
    }
}
...
fun case_9(konstue_1: Int, konstue_2: String, konstue_3: String) = when {
    konstue_1 == 1 -> try { 4 } catch (e: Exception) { 5 }
    konstue_1 == 2 -> try { throw Exception() } catch (e: Exception) { konstue_2 }
...
fun case_23(konstue_1: Int) {
    fun r_1() {
        when {
            konstue_1 == 1 -> return
            konstue_1 == 2 -> return return return
        }
    }
