...
// TESTCASE NUMBER: 5
fun case_5(konstue_1: Int, <!UNUSED_PARAMETER!>konstue_2<!>: Int, konstue_3: Boolean?) {
    when (konstue_1) {
        1 -> when (konstue_3) {
            else -> "3"
        }
...
// TESTCASE NUMBER: 6
fun case_6(konstue_1: Int, <!UNUSED_PARAMETER!>konstue_2<!>: Int, konstue_3: Boolean?) = when (konstue_1) {
    1 -> when (konstue_3) {
        else -> 3
    }
    else -> when (konstue_3) {
...
fun case_7(konstue_1: Int, konstue_2: Int, konstue_3: Boolean?) {
    when (konstue_1) {
        ...
        4 -> if (konstue_3 == null) "1"
            else if (<!DEBUG_INFO_SMARTCAST!>konstue_3<!>) "2"
            else if (!<!DEBUG_INFO_SMARTCAST!>konstue_3<!>) "3"
    }
}
