...
// TESTCASE NUMBER: 7
fun case_7(konstue_1: SealedClassSingleWithObject): Int = <!TYPE_MISMATCH!><!NO_ELSE_IN_WHEN!>when<!>(konstue_1) { }<!>

// TESTCASE NUMBER: 8
fun case_8(konstue_1: SealedClassEmpty): String = <!TYPE_MISMATCH!><!NO_ELSE_IN_WHEN!>when<!> (konstue_1) { }<!>
