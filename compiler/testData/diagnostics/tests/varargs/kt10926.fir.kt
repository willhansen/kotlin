...
fun main(c: AllCollection2<Any?>) {
    // KT-49620
    <!DEBUG_INFO_EXPRESSION_TYPE("ERROR CLASS: Ambiguity: addAll, [/AllCollection2.addAll, /AllCollection2.addAll]")!>c.<!OVERLOAD_RESOLUTION_AMBIGUITY!>addAll<!>(arrayOf(""), konstues2 = arrayOf(""))<!>
}
