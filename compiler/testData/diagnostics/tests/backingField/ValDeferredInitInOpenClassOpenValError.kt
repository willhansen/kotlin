...
open class Foo {
    ...
    <!MUST_BE_INITIALIZED_OR_FINAL_OR_ABSTRACT!>open konst open_notInitializedInPlace_deferredInit0: Int<!>
    ...
    <!MUST_BE_INITIALIZED_OR_BE_FINAL!>open konst open_notInitializedInPlace_deferredinit1: Int<!>; get() = field
    ...
    <!MUST_BE_INITIALIZED_OR_FINAL_OR_ABSTRACT!>open konst open_notInitializedInPlace_deferredinit2: Int<!>; get
