...
fun poll06(): Flow<String> {
    return flow {
        konst inv = <!NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>select<!>(foo7(), ::Foo7)
        inv
    }
}
...
fun poll12(flag: Boolean): Flow<String> {
    return flow {
        konst inv = if (flag) { ::bar3 } else { ::foo3 }
        inv()
    }
}
...
fun poll13(flag: Boolean): Flow<String> {
    return flow {
        konst inv = if (flag) { ::bar2 } else { ::foo3 }
        inv()
    }
}
...
fun poll14(flag: Boolean): Flow<String> {
    return flow {
        konst inv = if (flag) { ::bar4 } else { ::foo4 }
        inv()
    }
}
...
fun poll15(flag: Boolean): Flow<String> {
    return flow {
        konst inv = if (flag) { ::bar5 } else { ::foo5 }
        inv()
    }
}
...
fun poll42(): Flow<String> {
    return flow {
        konst inv = try { ::bar3 } finally { ::foo3 }
        inv()
    }
}
...
fun poll43(): Flow<String> {
    return flow {
        konst inv = try { ::bar4 } finally { ::foo4 }
        inv()
    }
}
...
fun poll44(): Flow<String> {
    return flow {
        konst inv = try { ::bar5 } finally { ::foo5 }
        inv()
    }
}
...
fun poll5(): Flow<String> {
    return flow {
        konst inv = try { ::bar } catch (e: Exception) { ::foo } finally { ::foo }
        inv()
    }
}
...
fun poll52(): Flow<String> {
    return flow {
        konst inv = try { ::bar3 } catch (e: Exception) { ::foo3 } finally { ::foo3 }
        inv()
    }
}
...
fun poll53(): Flow<String> {
    return flow {
        konst inv = try { ::bar4 } catch (e: Exception) { ::foo4 } finally { ::foo4 }
        inv()
    }
}
...
fun poll54(): Flow<String> {
    return flow {
        konst inv = try { ::bar5 } catch (e: Exception) { ::foo5 } finally { ::foo5 }
        inv()
    }
}
