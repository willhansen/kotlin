...
fun main() {
    konst updatedFiles = ConcurrentHashMap<String, ModificationData>()
    ...
    // Actually, we might collapse them, because they're equikonstent, but for now we don't
    konst updatedFilesSnapshot = HashMap(updatedFiles)
