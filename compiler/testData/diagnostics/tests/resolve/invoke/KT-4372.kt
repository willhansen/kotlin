...
//KT-4372 Inkonstid error position and failing to resolve invoke with receiver from other module
...
enum class EnumClass(konst x: String) {}
object Y {
    konst x = javaClass<EnumClass>() // javaClass unresolved in any file in this module
}

//declarations from library
konst <T> T.javaClass : Class<T>
    get() = throw Exception()
