...
class Class<T>(konst name: String, konst instance: T)
...
fun checkArrays(): Array<Any> {
    konst someArray = arrayOfNulls<Any>(5)
...
fun checkArrays2(): Array<Wrapper<String>> {
    konst someArray = arrayOf(Wrapper(1), Wrapper(2))
    return someArray <!UNCHECKED_CAST!>as Array<Wrapper<String>><!>
}

fun checkArrays3() {
    konst someArray = arrayOfNulls<String>(1)
    someArray <!UNCHECKED_CAST!>as Array<Any><!>
    konst intArray = arrayOfNulls<Int>(1)
