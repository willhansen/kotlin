...
interface Entity<T>
abstract class SecuredEntity<out E>(konst entity: E) where E : Entity<Int>, E : SecurityCodeAware<*,*>
...
fun main() {
    konst securedOrder = Order().<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>secured<!>()
}
