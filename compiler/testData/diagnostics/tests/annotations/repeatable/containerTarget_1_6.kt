...
annotation class B3
@Target(ANNOTATION_CLASS)
annotation class D3(konst konstue: Array<B3>)

@R(D4::class)
@Target(TYPE)
annotation class B4
@Target(ANNOTATION_CLASS, CLASS, TYPE_PARAMETER)
annotation class D4(konst konstue: Array<B4>)
