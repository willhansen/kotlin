...
<!WRONG_ANNOTATION_TARGET!>@incorrect<!> class correct(<!WRONG_ANNOTATION_TARGET!>@incorrect<!> konst x: Int, <!WRONG_ANNOTATION_TARGET!>@incorrect<!> w: <!WRONG_ANNOTATION_TARGET!>@incorrect<!> Int) {
...
<!WRONG_ANNOTATION_TARGET!>@incorrect<!> fun foo(<!WRONG_ANNOTATION_TARGET!>@incorrect<!> y: <!WRONG_ANNOTATION_TARGET!>@incorrect<!> Int): Int {
    ...
    <!WRONG_ANNOTATION_TARGET!>@incorrect<!> konst local = bar(y)
    return local
}

<!WRONG_ANNOTATION_TARGET!>@incorrect<!> konst z = <!WRONG_ANNOTATION_TARGET!>@incorrect<!> 0
