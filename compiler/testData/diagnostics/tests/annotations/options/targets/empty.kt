...
<!WRONG_ANNOTATION_TARGET!>@empty<!> class correct(<!WRONG_ANNOTATION_TARGET!>@empty<!> konst x: Int, <!WRONG_ANNOTATION_TARGET!>@empty<!> w: <!WRONG_ANNOTATION_TARGET!>@empty<!> Int) {
...
<!WRONG_ANNOTATION_TARGET!>@empty<!> fun foo(<!WRONG_ANNOTATION_TARGET!>@empty<!> y: <!WRONG_ANNOTATION_TARGET!>@empty<!> Int): Int {
    ...
    <!WRONG_ANNOTATION_TARGET!>@empty<!> konst local = bar(y)
    return local
}

<!WRONG_ANNOTATION_TARGET!>@empty<!> konst z = <!WRONG_ANNOTATION_TARGET!>@empty<!> 0
