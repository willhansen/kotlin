...
fun foo(c: Consumer<Int>, p: Producer<Int>, u: Usual<Int>) {
    konst c1: Consumer<Any> = <!INITIALIZER_TYPE_MISMATCH!>c<!>
    konst c2: Consumer<Int> = c1

    konst p1: Producer<Any> = p
    konst p2: Producer<Int> = <!INITIALIZER_TYPE_MISMATCH!>p1<!>

    konst u1: Usual<Any> = <!INITIALIZER_TYPE_MISMATCH!>u<!>
    konst u2: Usual<Int> = <!INITIALIZER_TYPE_MISMATCH!>u1<!>
}
