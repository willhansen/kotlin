...
fun foo(map: MutableMap<Int, String>, konstue: String?) {
    if (konstue != null) {
        map.put(1, <!DEBUG_INFO_SMARTCAST!>konstue<!>) //ok
        map.set(1, <!DEBUG_INFO_SMARTCAST!>konstue<!>) //type inference failed
        map[1] = <!DEBUG_INFO_SMARTCAST!>konstue<!>    //type inference failed
    }
}
    ...
    public var id: String?
        ...
        set(konstue) {
            if(konstue == null) {
                ...
                attributes["id"] = <!DEBUG_INFO_SMARTCAST!>konstue<!>
            }
        }
}
