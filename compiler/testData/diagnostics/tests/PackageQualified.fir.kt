...
package foobar.a
    ...
    konst a2 : <!UNRESOLVED_REFERENCE!>util.List<Int><!>? = null
...
package foobar.a
    ...
    konst b : List<Int>? = <!INITIALIZER_TYPE_MISMATCH!>a<!>
    konst b1 : <!UNRESOLVED_REFERENCE!>util.List<Int><!>? = a

// FILE: d.kt
package foobar
konst x1 = <!UNRESOLVED_REFERENCE!>a<!>.a
konst x2 = foobar.a.a
