...
@___("") data class Pair(konst x: Int, konst y: Int)
...
fun <!UNDERSCORE_IS_RESERVED!>__<!>(<!UNDERSCORE_IS_RESERVED!>___<!>: Int, y: <!UNDERSCORE_USAGE_WITHOUT_BACKTICKS!>_<!><Int>?): Int {
    ...
    konst `_` = <!UNDERSCORE_USAGE_WITHOUT_BACKTICKS!>__________<!>

    konst q = fun(_: Int, <!UNDERSCORE_IS_RESERVED!>__<!>: Int) {}
    q(1, 2)

    konst <!UNDERSCORE_IS_RESERVED!>_<!> = 56
...
class A1(konst <!UNDERSCORE_IS_RESERVED, UNDERSCORE_IS_RESERVED!>_<!>: String)
