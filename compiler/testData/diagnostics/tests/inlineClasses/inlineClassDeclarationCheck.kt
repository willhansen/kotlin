...
class B1 {
    companion object {
        ...
        <!WRONG_MODIFIER_CONTAINING_DECLARATION!>inner<!> inline class C11(konst x: Int)
    }
...
object B2 {
    ...
    <!WRONG_MODIFIER_CONTAINING_DECLARATION!>inner<!> inline class C31(konst x: Int)
}
...
<!INCOMPATIBLE_MODIFIERS!>inline<!> <!INCOMPATIBLE_MODIFIERS!>data<!> class <!CONFLICTING_JVM_DECLARATIONS, CONFLICTING_JVM_DECLARATIONS, CONFLICTING_JVM_DECLARATIONS!>D4(konst x: String)<!>
