...
open class WithDelegation(konst m: Map<String, String>) : Map<String, String> by m
...
abstract class WithDelegation2(konst m: Map<String, String>) : Map<String, String> by m, IBaseWithKotlinDeclaration
