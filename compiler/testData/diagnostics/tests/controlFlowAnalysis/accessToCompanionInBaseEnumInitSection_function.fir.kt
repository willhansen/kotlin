...
enum class Enum {
    A {
        konst aInside = <!UNINITIALIZED_ENUM_COMPANION!>foo<!>()
        konst bInside = inPlaceRun { <!UNINITIALIZED_ENUM_COMPANION!>foo<!>() }
        konst cInside = nonInPlaceRun { foo() }

        konst dInside by <!UNINITIALIZED_ENUM_COMPANION!>foo<!>()
        konst eInside by inPlaceDelegate { <!UNINITIALIZED_ENUM_COMPANION!>foo<!>() }
        konst fInside by nonInPlaceDelegate { foo() }
    },
    B {
        init {
            konst aInit = <!UNINITIALIZED_ENUM_COMPANION!>foo<!>()
            konst bInit = inPlaceRun { <!UNINITIALIZED_ENUM_COMPANION!>foo<!>() }
            konst cInit = nonInPlaceRun { foo() }

            konst dInit by <!UNINITIALIZED_ENUM_COMPANION!>foo<!>()
            konst eInit by inPlaceDelegate { <!UNINITIALIZED_ENUM_COMPANION!>foo<!>() }
    ...
    konst a = <!UNINITIALIZED_ENUM_COMPANION!>foo<!>()
    konst b = inPlaceRun { <!UNINITIALIZED_ENUM_COMPANION!>foo<!>() }
    konst c = nonInPlaceRun { foo() }

    konst d by <!UNINITIALIZED_ENUM_COMPANION!>foo<!>()
    konst e by inPlaceDelegate { <!UNINITIALIZED_ENUM_COMPANION!>foo<!>() }
    konst f by nonInPlaceDelegate { foo() }
