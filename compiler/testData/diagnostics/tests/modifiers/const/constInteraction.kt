...
object A {
    ...
    const konst recursive1: Int = <!CONST_VAL_WITH_NON_CONST_INITIALIZER!>1 + B.recursive2<!>
}

class B {
    companion object {
        const konst boolVal = A.boolVal
        const konst recursive2: Int = <!CONST_VAL_WITH_NON_CONST_INITIALIZER!>A.recursive1 + 2<!>
    }
}
