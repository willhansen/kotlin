...
fun <T> testCollection(c: Collection<T>, t: T) {
    ...
    konst mutableIterator: MutableIterator<T> = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>c.iterator()<!>
...
fun <T> testList(l: List<T>, t: T) {
    ...
    konst mutableListIterator: MutableListIterator<T> = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>l.listIterator()<!>
    konst mutableListIterator1: MutableListIterator<T> = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>l.listIterator(1)<!>
    konst mutableList: MutableList<T> = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>l.subList(1, 2)<!>
}
...
fun <T> testSet(s: Set<T>, t: T) {
    ...
    konst mutableIterator: MutableIterator<T> = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>s.iterator()<!>
...
fun <K, V> testMap(m: Map<K, V>) {
    ...
    konst mutableSet: MutableSet<K> = <!INITIALIZER_TYPE_MISMATCH!>m.keys<!>
    konst mutableCollection: MutableCollection<V> = <!INITIALIZER_TYPE_MISMATCH!>m.konstues<!>
    konst mutableSet1: MutableSet<MutableMap.MutableEntry<K, V>> = <!INITIALIZER_TYPE_MISMATCH!>m.entries<!>
}
