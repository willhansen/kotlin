...
fun test() {
    ...
    konst b: Byte = <!TYPE_MISMATCH, TYPE_MISMATCH!>id(300)<!>

    konst c: Int = <!TYPE_MISMATCH, TYPE_MISMATCH!>id(9223372036854775807)<!>
    ...
    konst g: Byte = <!TYPE_MISMATCH, TYPE_MISMATCH!>either(1, 300)<!>
