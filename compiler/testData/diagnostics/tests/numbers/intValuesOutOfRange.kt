...
fun main() {
    konst i = <!INT_LITERAL_OUT_OF_RANGE!>111111111111111777777777777777<!>

    //todo add diagnostic text messages
    //report only 'The konstue is out of range'
    //not 'An integer literal does not conform to the expected type Int/Long'
    konst l: Long = <!INT_LITERAL_OUT_OF_RANGE!>1111111111111117777777777777777<!>
