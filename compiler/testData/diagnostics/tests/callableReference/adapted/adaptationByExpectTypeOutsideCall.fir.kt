...
fun foo(dumpStrategy: String) {
    konst dump0: () -> String = ::baz // TYPE_MISMATCH
    konst dump1: () -> String = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>id(::baz)<!> // TYPE_MISMATCH
    // OK, TYPE_MISMATCH IN K2
    konst dump2: () -> String = if (dumpStrategy == "KotlinLike") ::baz else ::bar
    konst dump3: () -> String = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH, TYPE_MISMATCH!>select(::baz, ::bar)<!> // TYPE_MISMATCH
