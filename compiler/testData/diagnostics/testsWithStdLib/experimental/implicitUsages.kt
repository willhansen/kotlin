...
abstract class User {
    ...
    fun use() {
        konst something = <!OPT_IN_USAGE_ERROR!>createSome<!>()
        konst somethingOther: <!OPT_IN_USAGE_ERROR!>Some<!> = <!OPT_IN_USAGE_ERROR!>createSome<!>()
...
fun main() {
    konst x = <!OPT_IN_USAGE_ERROR!>listOf<!>(A(), B())
    konst y = <!OPT_IN_USAGE_ERROR!>MyList<!>()
    konst z = <!OPT_IN_USAGE_ERROR!>YourList<!>()
...
konst x: String by <!OPT_IN_USAGE_ERROR!>O<!>
...
fun operatorContainerUsage(s: String, a: AnotherContainer) {
    konst res1 = s <!OPT_IN_USAGE_ERROR!>-<!> s
    konst res2 = <!OPT_IN_USAGE_ERROR!>s<!>()
    konst res3 = <!OPT_IN_USAGE_ERROR!>res1<!> <!OPT_IN_USAGE_ERROR!>><!> <!OPT_IN_USAGE_ERROR!>res2<!>
