...
fun main3() {
    konst x = A3<<!UPPER_BOUND_VIOLATED_WARNING!>Int?<!>>()
    konst x2 = A<<!UPPER_BOUND_VIOLATED!>Int?<!>>()
    konst y: <!UPPER_BOUND_VIOLATED_IN_TYPEALIAS_EXPANSION!>A3<Int?><!> = A3<<!UPPER_BOUND_VIOLATED_WARNING!>Int?<!>>()
}
