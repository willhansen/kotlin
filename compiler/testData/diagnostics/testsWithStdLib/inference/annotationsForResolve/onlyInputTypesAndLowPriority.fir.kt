...
fun test(map: Map<Int, String>) {
    konst a: Int = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>listOf(1).<!TYPE_INFERENCE_ONLY_INPUT_TYPES_ERROR!>contains1<!>("")<!>
    konst b: Boolean = listOf(1).contains1(1)

    konst c: String? = map.<!TYPE_INFERENCE_ONLY_INPUT_TYPES_ERROR!>get1<!>("")
    konst d: String? = map.get1(1)
}
