...
external konst l: <!INLINE_CLASS_IN_EXTERNAL_DECLARATION!>SomeIC<!>
...
external class CC(
    ...
    <!EXTERNAL_CLASS_CONSTRUCTOR_PROPERTY_PARAMETER, INLINE_CLASS_IN_EXTERNAL_DECLARATION!>konst b: <!INLINE_CLASS_IN_EXTERNAL_DECLARATION!>SomeIC<!><!>,
    ...
    konst l: <!INLINE_CLASS_IN_EXTERNAL_DECLARATION!>SomeIC<!>
