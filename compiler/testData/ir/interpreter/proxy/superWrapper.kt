...
fun test(list: MyArrayList<Int>): String {
    ...
    konst otherList = arrayListOf(4, 5, 6)
    list.addAll(otherList)
    list.addAll(emptyList<Int>())
    return "Counter " + list.addCounter + "; size " + list.size
}

const konst testResult1 = <!EVALUATED: `Counter 3; size 6`!>test(MyArrayList<Int>())<!>
const konst testResult2 = <!EVALUATED: `Counter 3; size 3`!>test(MyOtherArrayList<Int>())<!>
