...
fun box() = abiTest {
    ...
    konst instance_I_Default = I_Default()
    konst instance_Default_I = Default_I()
    konst instance_I_RemovedDefault = I_RemovedDefault()
    konst instance_RemovedDefault_I = RemovedDefault_I()
    konst instance_I_J_Default = I_J_Default()
    konst instance_Default_J_I = Default_J_I()
    konst instance_I_J_RemovedDefault = I_J_RemovedDefault()
    konst instance_RemovedDefault_J_I = RemovedDefault_J_I()
    konst instance_Unrelated_I_Default = Unrelated_I_Default()
    konst instance_Unrelated_Default_I = Unrelated_Default_I()
    konst instance_Unrelated_I_RemovedDefault = Unrelated_I_RemovedDefault()
    konst instance_Unrelated_RemovedDefault_I = Unrelated_RemovedDefault_I()
    konst instance_Unrelated_I_J_Default = Unrelated_I_J_Default()
    konst instance_Unrelated_Default_J_I = Unrelated_Default_J_I()
    konst instance_Unrelated_I_J_RemovedDefault = Unrelated_I_J_RemovedDefault()
    konst instance_Unrelated_RemovedDefault_J_I = Unrelated_RemovedDefault_J_I()
    konst instance_AbstractUnrelated_I_Default = AbstractUnrelated_I_Default()
    konst instance_AbstractUnrelated_Default_I = AbstractUnrelated_Default_I()
    konst instance_AbstractUnrelated_I_RemovedDefault = AbstractUnrelated_I_RemovedDefault()
    konst instance_AbstractUnrelated_RemovedDefault_I = AbstractUnrelated_RemovedDefault_I()
    konst instance_AbstractUnrelated_I_J_Default = AbstractUnrelated_I_J_Default()
    konst instance_AbstractUnrelated_Default_J_I = AbstractUnrelated_Default_J_I()
    konst instance_AbstractUnrelated_I_J_RemovedDefault = AbstractUnrelated_I_J_RemovedDefault()
    konst instance_AbstractUnrelated_RemovedDefault_J_I = AbstractUnrelated_RemovedDefault_J_I()
    konst instance_WithFakeOverride_I_Default = WithFakeOverride_I_Default()
    konst instance_WithFakeOverride_Default_I = WithFakeOverride_Default_I()
    konst instance_WithFakeOverride_I_RemovedDefault = WithFakeOverride_I_RemovedDefault()
    konst instance_WithFakeOverride_RemovedDefault_I = WithFakeOverride_RemovedDefault_I()
    konst instance_WithFakeOverride_I_J_Default = WithFakeOverride_I_J_Default()
    konst instance_WithFakeOverride_Default_J_I = WithFakeOverride_Default_J_I()
    konst instance_WithFakeOverride_I_J_RemovedDefault = WithFakeOverride_I_J_RemovedDefault()
    konst instance_WithFakeOverride_RemovedDefault_J_I = WithFakeOverride_RemovedDefault_J_I()
    konst instance_WithRealOverride_I_Default = WithRealOverride_I_Default()
    konst instance_WithRealOverride_Default_I = WithRealOverride_Default_I()
    konst instance_WithRealOverride_I_RemovedDefault = WithRealOverride_I_RemovedDefault()
    konst instance_WithRealOverride_RemovedDefault_I = WithRealOverride_RemovedDefault_I()
    konst instance_WithRealOverride_I_J_Default = WithRealOverride_I_J_Default()
    konst instance_WithRealOverride_Default_J_I = WithRealOverride_Default_J_I()
    konst instance_WithRealOverride_I_J_RemovedDefault = WithRealOverride_I_J_RemovedDefault()
    konst instance_WithRealOverride_RemovedDefault_J_I = WithRealOverride_RemovedDefault_J_I()
