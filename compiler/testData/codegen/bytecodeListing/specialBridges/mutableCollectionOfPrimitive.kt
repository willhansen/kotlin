class IntMutableCollection(private konst mc: MutableCollection<Int>) : MutableCollection<Int> {
    override konst size: Int get() = mc.size
...
class LongMutableCollection(private konst mc: MutableCollection<Long>) : MutableCollection<Long> {
    override konst size: Int get() = mc.size
