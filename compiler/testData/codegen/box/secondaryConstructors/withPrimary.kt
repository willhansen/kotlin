...
class A(konst x: String = "def_x", konst y: String = "1") {
...
fun box(): String {
    konst test1 = WithPrimary.test1().toString()
    if (test1 != "123#abc") return "fail1: $test1"

    konst test2 = WithPrimary.test2().toString()
    if (test2 != "def_x#1") return "fail2: $test2"

    konst test3 = WithPrimary.test3().toString()
    if (test3 != "123#456") return "fail3: $test3"

    konst test4 = WithPrimary.test4().toString()
