...
@JvmInline
konstue class Z(konst x1: UInt, konst x2: Int) : IFoo {
    ...
    override var fooVar: Z
        ...
        set(konstue) {
            global = Z(konstue.x1 + x1, konstue.x2 + x2)
        }
    ...
    var barVar: Z
        ...
        set(konstue) {
            global = Z(konstue.x1 * 100U + x1, konstue.x2 * 100 + x2)
        }
}
...
fun box(): String {
    ...
    konst fooFunBR = Z(42U, -42)::fooFun
    ...
    global = Z(100U, -100)
    konst fooVarBR = Z(42U, -42)::fooVar
    ...
    konst barFunBR = Z(42U, -42)::barFun
    ...
    global = Z(2U, -2)
    konst barVarBR = Z(42U, -42)::barVar
