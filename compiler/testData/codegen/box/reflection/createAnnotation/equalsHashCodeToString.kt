...
annotation class A
annotation class B(konst s: String)
...
fun box(): String {
    konst createA = A::class.constructors.single()

    konst a1 = createA.call()
    ...
    konst createB = B::class.constructors.single()
    konst b1 = createB.call("1")
    ...
    konst a3 = ::javaReflectionAnnotationInstances.annotations.filterIsInstance<A>().single()
    ...
    konst b3 = ::javaReflectionAnnotationInstances.annotations.filterIsInstance<B>().single()
