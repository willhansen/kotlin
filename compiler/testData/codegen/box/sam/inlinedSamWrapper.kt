...
fun box(): String {
    ...
    konst inlineWrapperA = classForName("foo.A\$sam\$i\$java_lang_Runnable$0")
    ...
    konst wrapperA = classForName("foo.A\$sam\$java_lang_Runnable$0")
    ...
    konst inlineWrapperB = classForName("foo.B\$sam\$i\$java_lang_Runnable$0")
    if (inlineWrapperB != null) return "Fail 9: sam wrapper not cached"

    konst wrapperB = classForName("foo.B\$sam\$MyRunnable$0")
