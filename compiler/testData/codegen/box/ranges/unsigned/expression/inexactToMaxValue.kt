...
fun box(): String {
    ...
    konst range1 = (MaxUI - 5u)..MaxUI step 3
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = (MaxUB - 5u).toUByte()..MaxUB step 3
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = (MaxUS - 5u).toUShort()..MaxUS step 3
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = (MaxUL - 5u)..MaxUL step 3
    for (i in range4) {
        list4.add(i)
