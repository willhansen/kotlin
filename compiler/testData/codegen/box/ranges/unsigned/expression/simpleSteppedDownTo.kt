...
fun box(): String {
    ...
    konst range1 = 9u downTo 3u step 2
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = 9u.toUByte() downTo 3u.toUByte() step 2
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = 9u.toUShort() downTo 3u.toUShort() step 2
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = 9uL downTo 3uL step 2L
    for (i in range4) {
        list4.add(i)
