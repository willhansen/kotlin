...
fun box(): String {
    ...
    konst range1 = (3u..9u step 2).reversed()
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = (3u.toUByte()..9u.toUByte() step 2).reversed()
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = (3u.toUShort()..9u.toUShort() step 2).reversed()
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = (3uL..9uL step 2L).reversed()
    for (i in range4) {
        list4.add(i)
