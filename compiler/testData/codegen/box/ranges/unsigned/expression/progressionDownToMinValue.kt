...
fun box(): String {
    ...
    konst range1 = (MinUI + 2u) downTo MinUI step 1
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = (MinUB + 2u).toUByte() downTo MinUB step 1
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = (MinUS + 2u).toUShort() downTo MinUS step 1
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = (MinUL + 2u) downTo MinUL step 1
    for (i in range4) {
        list4.add(i)
