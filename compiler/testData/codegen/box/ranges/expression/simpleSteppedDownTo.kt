...
fun box(): String {
    ...
    konst range1 = 9 downTo 3 step 2
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = 9.toByte() downTo 3.toByte() step 2
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = 9.toShort() downTo 3.toShort() step 2
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = 9L downTo 3L step 2L
    for (i in range4) {
        list4.add(i)
    ...
    konst range5 = 'g' downTo 'c' step 2
    for (i in range5) {
        list5.add(i)
