...
fun box(): String {
    ...
    konst range1 = (3..9 step 2).reversed()
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = (3.toByte()..9.toByte() step 2).reversed()
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = (3.toShort()..9.toShort() step 2).reversed()
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = (3L..9L step 2L).reversed()
    for (i in range4) {
        list4.add(i)
    ...
    konst range5 = ('c'..'g' step 2).reversed()
    for (i in range5) {
        list5.add(i)
