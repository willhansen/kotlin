...
fun box(): String {
    ...
    konst range1 = (MaxI - 2)..MaxI step 2
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = (MaxB - 2).toByte()..MaxB step 2
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = (MaxS - 2).toShort()..MaxS step 2
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = (MaxL - 2).toLong()..MaxL step 2
    for (i in range4) {
        list4.add(i)
    ...
    konst range5 = (MaxC - 2)..MaxC step 2
    for (i in range5) {
        list5.add(i)
