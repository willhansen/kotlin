...
fun box(): String {
    ...
    konst range1 = (5 downTo 3).reversed()
    for (i in range1) {
        list1.add(i)
    ...
    konst range2 = (5.toByte() downTo 3.toByte()).reversed()
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = (5.toShort() downTo 3.toShort()).reversed()
    for (i in range3) {
        list3.add(i)
    ...
    konst range4 = (5L downTo 3L).reversed()
    for (i in range4) {
        list4.add(i)
    ...
    konst range5 = ('c' downTo 'a').reversed()
    for (i in range5) {
        list5.add(i)
