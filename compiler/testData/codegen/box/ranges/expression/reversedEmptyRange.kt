...
fun box(): String {
    ...
    konst range2 = (5.toByte()..3.toByte()).reversed()
    for (i in range2) {
        list2.add(i)
    ...
    konst range3 = (5.toShort()..3.toShort()).reversed()
    for (i in range3) {
        list3.add(i)
