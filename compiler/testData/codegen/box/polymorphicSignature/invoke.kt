...
fun box(): String {
    ...
    konst result1: String = mh.invoke(C(), "Hello", 0.01, Derived()) as String
    if (result1 != "Hello0.01!") return "Fail 1: $result1"

    // Check parenthesized/annotated expressions + invoke via "()"
    konst result2 = (@IrrelevantAnnotation() ((mh(C(), (("Hello")), 0.01, Derived())))) as String
    ...
    konst result3 = (o.p).handle.invoke(C(), "Hello", 0.01, Derived()) as String
