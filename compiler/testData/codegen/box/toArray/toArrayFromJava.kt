...
// FILE: a.kt
class MyList<T>(konst list: List<T>): java.util.AbstractList<T>() {
...
class MyListSubclass<T>(konst list: List<T>): MyListWithCustomToArray<T>() {
    override fun get(index: Int): T = list[index]
...
class MyCollectionWithCustomIntToArray<T>(konst list: List<T>) : Collection<T> by list {
    fun toArray(): Array<Int?> =
        arrayOfNulls<Int>(0)
}

fun box(): String {
    konst list1 = MyList(listOf(2, 3, 9)) as java.util.Collection<*>
    ...
    konst list2 = MyListSubclass(listOf(2, 3, 9)) as java.util.Collection<*>
    ...
    konst list3 = MyCollectionWithCustomIntToArray(listOf(2, 3, 9)) as java.util.Collection<*>
    /*
