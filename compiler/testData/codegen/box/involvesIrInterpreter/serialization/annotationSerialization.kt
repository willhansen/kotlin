...
annotation class BinaryAnnotation(konst str: String)

// 1. CLASS
// 8. CONSTRUCTOR
@BinaryAnnotation("Str" <!EVALUATED("String")!>+ "ing"<!>)
class A @BinaryAnnotation("Str" <!EVALUATED("String")!>+ "ing"<!>) constructor(konst i: Int) {
...
konst @receiver:BinaryAnnotation("Str" <!EVALUATED("String")!>+ "ing"<!>) String.a: Int
    get() = 0
...
var b: Int
    ...
    @BinaryAnnotation("Str" <!EVALUATED("String")!>+ "ing"<!>) set(konstue) {}
