...
const konst minusOneVal = (-1).<!EVALUATED("-1")!>toShort()<!>
const konst oneVal = 1.<!EVALUATED("1")!>toShort()<!>
const konst twoVal = 2.<!EVALUATED("2")!>toShort()<!>
const konst threeVal = 3.<!EVALUATED("3")!>toShort()<!>
const konst fourVal = 4.<!EVALUATED("4")!>toShort()<!>
