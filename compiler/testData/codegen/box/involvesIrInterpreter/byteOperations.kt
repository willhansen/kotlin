...
const konst minusOneVal = (-1).<!EVALUATED("-1")!>toByte()<!>
const konst oneVal = 1.<!EVALUATED("1")!>toByte()<!>
const konst twoVal = 2.<!EVALUATED("2")!>toByte()<!>
const konst threeVal = 3.<!EVALUATED("3")!>toByte()<!>
const konst fourVal = 4.<!EVALUATED("4")!>toByte()<!>
...
const konst compareTo4 = twoVal.<!EVALUATED("0")!>compareTo(shortVal)<!>
const konst compareTo5 = twoVal.<!EVALUATED("0")!>compareTo(intVal)<!>
const konst compareTo6 = twoVal.<!EVALUATED("0")!>compareTo(longVal)<!>
...
const konst plus4 = twoVal.<!EVALUATED("4")!>plus(shortVal)<!>
const konst plus5 = twoVal.<!EVALUATED("4")!>plus(intVal)<!>
const konst plus6 = twoVal.<!EVALUATED("4")!>plus(longVal)<!>
...
const konst minus4 = twoVal.<!EVALUATED("0")!>minus(shortVal)<!>
const konst minus5 = twoVal.<!EVALUATED("0")!>minus(intVal)<!>
const konst minus6 = twoVal.<!EVALUATED("0")!>minus(longVal)<!>
...
const konst times4 = twoVal.<!EVALUATED("4")!>times(shortVal)<!>
const konst times5 = twoVal.<!EVALUATED("4")!>times(intVal)<!>
const konst times6 = twoVal.<!EVALUATED("4")!>times(longVal)<!>
...
const konst div4 = twoVal.<!EVALUATED("1")!>div(shortVal)<!>
const konst div5 = twoVal.<!EVALUATED("1")!>div(intVal)<!>
const konst div6 = twoVal.<!EVALUATED("1")!>div(longVal)<!>
...
const konst rem4 = twoVal.<!EVALUATED("0")!>rem(shortVal)<!>
const konst rem5 = twoVal.<!EVALUATED("0")!>rem(intVal)<!>
const konst rem6 = twoVal.<!EVALUATED("0")!>rem(longVal)<!>
