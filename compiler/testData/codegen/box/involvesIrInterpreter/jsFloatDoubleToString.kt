...
const konst toStringDouble1 = 1.0.<!EVALUATED("1")!>toString()<!>
const konst toStringDouble2 = 2.0.<!EVALUATED("2")!>toString()<!>
const konst toStringDouble3 = 1.5.<!EVALUATED("1.5")!>toString()<!>

const konst toStringFloat1 = 1.0f.<!EVALUATED("1")!>toString()<!>
const konst toStringFloat2 = 2.0f.<!EVALUATED("2")!>toString()<!>
...
fun box(): String {
    ...
    konst localDoubleToString = 1.0.<!EVALUATED("1")!>toString()<!>
    konst localFloatToString = 1.0f.<!EVALUATED("1")!>toString()<!>
    // STOP_EVALUATION_CHECKS
