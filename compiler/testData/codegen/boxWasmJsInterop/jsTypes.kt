...
fun box(): String {
    // JsNumber
    konst jsNum10: JsNumber = 10.toJsNumber()
    konst anotherJsNum10: JsNumber = 10.toDouble().toJsNumber()
    assertTrue(jsNum10 == anotherJsNum10)
    assertTrue(jsNum10.toDouble() == 10.0)
    assertTrue(anotherJsNum10.toInt() == 10)
    konst jsNumAsJsAny: JsAny = jsNum10
    ...
    // JsString
    konst jsStr1: JsString = "str1".toJsString()
    ...
    // JsString
    konst jsBoolTrue: JsBoolean = true.toJsBoolean()
    ...
    // JsArray
    konst jsArray: JsArray<JsString> = JsArray()
    repeat(3) {
    ...
    // JsReference
    konst jsReference: JsReference<Int> = 10.toJsReference()
