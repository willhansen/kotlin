...
public class TestMap<K, V> implements Map<K, V> {
    ...
    public boolean containsValue(Object konstue) { return false; }
    public V get(Object key) { return null; }
    public V put(K key, V konstue) { return null; }
    public V remove(Object key) { return null; }
    public void putAll(Map<? extends K, ? extends V> m) {}
    public Set<K> keySet() { return Collections.EMPTY_SET; }
    public Collection<V> konstues() {return Collections.EMPTY_SET; }
