 ...
 */
data class KotlinSourceRoot(konst path: String, konst isCommon: Boolean, konst hmppModuleName: String?): ContentRoot
...
konst CompilerConfiguration.kotlinSourceRoots: List<KotlinSourceRoot>
