...
object GeneratePrimitiveVsObjectEqualityTestData {
    private konst TEST_DATA_DIR = File("compiler/testData/codegen/box/primitiveTypes/equalityWithObject")
    private konst GENERATED_DIR = File(TEST_DATA_DIR, "generated")

    private konst PREAMBLE_MESSAGE = "Auto-generated by ${this::class.java.simpleName}. Do not edit!"
    ...
    private fun PrintWriter.generateLocalVals(type: String, x: String, y: String, boxedType: String = "$type?") {
        println("    konst ax: $boxedType = $x")
        println("    konst an: $boxedType = null")
        println("    konst bx: $type = $x")
        println("    konst by: $type = $y")
    }

    private fun PrintWriter.generateGlobalVals(type: String, x: String, y: String, boxedType: String = "$type?") {
        println("konst nx: $boxedType = $x")
        println("konst nn: $boxedType = null")
        println("konst x: $type = $x")
        println("konst y: $type = $y")
    }
