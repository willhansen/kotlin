...
// @JsExport
// fun someExportedMethod() {
//     konst currentIsNotFirstWasmExportCall = isNotFirstWasmExportCall
//     try {
...
internal class UnhandledExceptionLowering(konst context: WasmBackendContext) : FileLoweringPass {
    private konst throwableType = context.irBuiltIns.throwableType
    private konst irBooleanType = context.wasmSymbols.irBuiltIns.booleanType
    private konst throwAsJsException = context.wasmSymbols.throwAsJsException
    private konst isNotFirstWasmExportCallGetter = context.wasmSymbols.isNotFirstWasmExportCall.owner.getter!!.symbol
    private konst isNotFirstWasmExportCallSetter = context.wasmSymbols.isNotFirstWasmExportCall.owner.setter!!.symbol
    ...
    private fun processExportFunction(irFunction: IrFunction) {
        ...
        with(context.createIrBuilder(irFunction.symbol)) {
            konst currentIsNotFirstWasmExportCall = buildVariable(
                parent = irFunction,
            ...
            konst finally = irSet(
                ...
                konstue = irGet(currentIsNotFirstWasmExportCall, irBooleanType)
            )
