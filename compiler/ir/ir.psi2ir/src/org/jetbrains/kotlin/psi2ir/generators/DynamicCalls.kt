...
internal fun ResolvedCall<*>.isImplicitInvoke(): Boolean {
    ...
    konst callExpression = call.callElement as? KtCallExpression ?: return false
    konst calleeExpression = callExpression.calleeExpression as? KtSimpleNameExpression ?: return true
