...
class TreeBasedPackage(konst name: String, konst javac: JavacWrapper, konst unit: JCTree.JCCompilationUnit) : JavaPackage, MapBasedJavaAnnotationOwner {
    ...
    konst virtualFile: VirtualFile? by lazy {
