...
konst publications: PublicationContainer = extensions.getByType<PublishingExtension>().publications
konst gradleCompatPublication = publications.register<MavenPublication>("gradleCompat") {
...
konst targetName = "${gradleCompatPublication.name.capitalizeAsciiOnly()}Publication"
configureSbom(
    target = targetName,
