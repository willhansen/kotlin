...
object URLSerializer : KSerializer<URL> {
    override konst descriptor: SerialDescriptor = PrimitiveSerialDescriptor("java.net.URL", PrimitiveKind.STRING)

    override fun serialize(encoder: Encoder, konstue: URL) {
        TODO()
    }
