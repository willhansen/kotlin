...
class CXString(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var data: COpaquePointer?
        get() = memberAt<COpaquePointerVar>(0).konstue
        set(konstue) { memberAt<COpaquePointerVar>(0).konstue = konstue }
    
    var private_flags: Int
        get() = memberAt<IntVar>(8).konstue
        set(konstue) { memberAt<IntVar>(8).konstue = konstue }
}
...
class CXStringSet(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var Strings: CPointer<CXString>?
        get() = memberAt<CPointerVar<CXString>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CXString>>(0).konstue = konstue }
...
class CXUnsavedFile(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var Filename: CPointer<ByteVar>?
        get() = memberAt<CPointerVar<ByteVar>>(0).konstue
        set(konstue) { memberAt<CPointerVar<ByteVar>>(0).konstue = konstue }
    
    var Contents: CPointer<ByteVar>?
        get() = memberAt<CPointerVar<ByteVar>>(8).konstue
        set(konstue) { memberAt<CPointerVar<ByteVar>>(8).konstue = konstue }
    
    var Length: Int
        get() = memberAt<IntVar>(16).konstue
        set(konstue) { memberAt<IntVar>(16).konstue = konstue }
}
...
class CXVersion(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var Major: Int
        ...
        set(konstue) { memberAt<IntVar>(0).konstue = konstue }
    
    var Minor: Int
        get() = memberAt<IntVar>(4).konstue
        set(konstue) { memberAt<IntVar>(4).konstue = konstue }
...
class CXFileUniqueID(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    @CLength(3)
    konst data: CArrayPointer<LongVar>
        get() = arrayMemberAt(0)
}
...
class CXSourceLocation(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    @CLength(2)
    konst ptr_data: CArrayPointer<COpaquePointerVar>
        get() = arrayMemberAt(0)
...
class CXSourceRange(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var end_int_data: Int
        get() = memberAt<IntVar>(20).konstue
        set(konstue) { memberAt<IntVar>(20).konstue = konstue }
}
...
class CXSourceRangeList(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var ranges: CPointer<CXSourceRange>?
        get() = memberAt<CPointerVar<CXSourceRange>>(8).konstue
        set(konstue) { memberAt<CPointerVar<CXSourceRange>>(8).konstue = konstue }
}
...
class CXTUResourceUsageEntry(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var kind: CXTUResourceUsageKind
        get() = memberAt<CXTUResourceUsageKind.Var>(0).konstue
        set(konstue) { memberAt<CXTUResourceUsageKind.Var>(0).konstue = konstue }
...
class CXTUResourceUsage(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var entries: CPointer<CXTUResourceUsageEntry>?
        get() = memberAt<CPointerVar<CXTUResourceUsageEntry>>(16).konstue
        set(konstue) { memberAt<CPointerVar<CXTUResourceUsageEntry>>(16).konstue = konstue }
}
...
class CXCursor(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var kind: CXCursorKind
        get() = memberAt<CXCursorKind.Var>(0).konstue
        set(konstue) { memberAt<CXCursorKind.Var>(0).konstue = konstue }
    ...
    @CLength(3)
    konst data: CArrayPointer<COpaquePointerVar>
        get() = arrayMemberAt(8)
}
...
class CXPlatformAvailability(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    konst Platform: CXString
        get() = memberAt(0)
    
    konst Introduced: CXVersion
        get() = memberAt(16)
    
    konst Deprecated: CXVersion
        get() = memberAt(28)
    
    konst Obsoleted: CXVersion
        get() = memberAt(40)
    
    var Unavailable: Int
        get() = memberAt<IntVar>(52).konstue
        set(konstue) { memberAt<IntVar>(52).konstue = konstue }
    
    konst Message: CXString
        get() = memberAt(56)
}
...
class CXType(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var kind: CXTypeKind
        get() = memberAt<CXTypeKind.Var>(0).konstue
        set(konstue) { memberAt<CXTypeKind.Var>(0).konstue = konstue }
...
class CXToken(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    @CLength(4)
    konst int_data: CArrayPointer<IntVar>
        get() = arrayMemberAt(0)
    
    var ptr_data: COpaquePointer?
        get() = memberAt<COpaquePointerVar>(16).konstue
        set(konstue) { memberAt<COpaquePointerVar>(16).konstue = konstue }
}
...
class CXCompletionResult(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var CompletionString: CXCompletionString?
        get() = memberAt<CXCompletionStringVar>(8).konstue
        set(konstue) { memberAt<CXCompletionStringVar>(8).konstue = konstue }
}
...
class CXCodeCompleteResults(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var Results: CPointer<CXCompletionResult>?
        get() = memberAt<CPointerVar<CXCompletionResult>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CXCompletionResult>>(0).konstue = konstue }
...
class CXCursorAndRangeVisitor(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var visit: CPointer<CFunction<(COpaquePointer?, CValue<CXCursor>, CValue<CXSourceRange>) -> CXVisitorResult>>?
        get() = memberAt<CPointerVar<CFunction<(COpaquePointer?, CValue<CXCursor>, CValue<CXSourceRange>) -> CXVisitorResult>>>(8).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(COpaquePointer?, CValue<CXCursor>, CValue<CXSourceRange>) -> CXVisitorResult>>>(8).konstue = konstue }
}
...
class CXIdxIncludedFileInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    konst hashLoc: CXIdxLoc
        get() = memberAt(0)
    
    var filename: CPointer<ByteVar>?
        get() = memberAt<CPointerVar<ByteVar>>(24).konstue
        set(konstue) { memberAt<CPointerVar<ByteVar>>(24).konstue = konstue }
    
    var file: CXFile?
        get() = memberAt<CXFileVar>(32).konstue
        set(konstue) { memberAt<CXFileVar>(32).konstue = konstue }
    
    var isImport: Int
        get() = memberAt<IntVar>(40).konstue
        set(konstue) { memberAt<IntVar>(40).konstue = konstue }
    
    var isAngled: Int
        get() = memberAt<IntVar>(44).konstue
        set(konstue) { memberAt<IntVar>(44).konstue = konstue }
    
    var isModuleImport: Int
        get() = memberAt<IntVar>(48).konstue
        set(konstue) { memberAt<IntVar>(48).konstue = konstue }
}
...
class CXIdxImportedASTFileInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var file: CXFile?
        get() = memberAt<CXFileVar>(0).konstue
        set(konstue) { memberAt<CXFileVar>(0).konstue = konstue }
    
    var module: CXModule?
        get() = memberAt<CXModuleVar>(8).konstue
        set(konstue) { memberAt<CXModuleVar>(8).konstue = konstue }
...
class CXIdxAttrInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var kind: CXIdxAttrKind
        get() = memberAt<CXIdxAttrKindVar>(0).konstue
        set(konstue) { memberAt<CXIdxAttrKindVar>(0).konstue = konstue }
    
    konst cursor: CXCursor
        get() = memberAt(8)
...
class CXIdxEntityInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var kind: CXIdxEntityKind
        get() = memberAt<CXIdxEntityKind.Var>(0).konstue
        set(konstue) { memberAt<CXIdxEntityKind.Var>(0).konstue = konstue }
    
    var templateKind: CXIdxEntityCXXTemplateKind
        get() = memberAt<CXIdxEntityCXXTemplateKindVar>(4).konstue
        set(konstue) { memberAt<CXIdxEntityCXXTemplateKindVar>(4).konstue = konstue }
    
    var lang: CXIdxEntityLanguage
        get() = memberAt<CXIdxEntityLanguageVar>(8).konstue
        set(konstue) { memberAt<CXIdxEntityLanguageVar>(8).konstue = konstue }
    
    var name: CPointer<ByteVar>?
        get() = memberAt<CPointerVar<ByteVar>>(16).konstue
        set(konstue) { memberAt<CPointerVar<ByteVar>>(16).konstue = konstue }
    ...
    var attributes: CPointer<CPointerVar<CXIdxAttrInfo>>?
        get() = memberAt<CPointerVar<CPointerVar<CXIdxAttrInfo>>>(64).konstue
        set(konstue) { memberAt<CPointerVar<CPointerVar<CXIdxAttrInfo>>>(64).konstue = konstue }
    
    var numAttributes: Int
        get() = memberAt<IntVar>(72).konstue
        set(konstue) { memberAt<IntVar>(72).konstue = konstue }
}
...
class CXIdxIBOutletCollectionAttrInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var attrInfo: CPointer<CXIdxAttrInfo>?
        get() = memberAt<CPointerVar<CXIdxAttrInfo>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxAttrInfo>>(0).konstue = konstue }
    
    var objcClass: CPointer<CXIdxEntityInfo>?
        get() = memberAt<CPointerVar<CXIdxEntityInfo>>(8).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxEntityInfo>>(8).konstue = konstue }
    
    konst classCursor: CXCursor
        get() = memberAt(16)
    
    konst classLoc: CXIdxLoc
        get() = memberAt(48)
}
...
class CXIdxDeclInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var entityInfo: CPointer<CXIdxEntityInfo>?
        get() = memberAt<CPointerVar<CXIdxEntityInfo>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxEntityInfo>>(0).konstue = konstue }
    ...
    var semanticContainer: CPointer<CXIdxContainerInfo>?
        get() = memberAt<CPointerVar<CXIdxContainerInfo>>(64).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxContainerInfo>>(64).konstue = konstue }
    
    var lexicalContainer: CPointer<CXIdxContainerInfo>?
        get() = memberAt<CPointerVar<CXIdxContainerInfo>>(72).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxContainerInfo>>(72).konstue = konstue }
    
    var isRedeclaration: Int
        get() = memberAt<IntVar>(80).konstue
        set(konstue) { memberAt<IntVar>(80).konstue = konstue }
    
    var isDefinition: Int
        get() = memberAt<IntVar>(84).konstue
        set(konstue) { memberAt<IntVar>(84).konstue = konstue }
    
    var isContainer: Int
        get() = memberAt<IntVar>(88).konstue
        set(konstue) { memberAt<IntVar>(88).konstue = konstue }
    
    var declAsContainer: CPointer<CXIdxContainerInfo>?
        get() = memberAt<CPointerVar<CXIdxContainerInfo>>(96).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxContainerInfo>>(96).konstue = konstue }
    
    var isImplicit: Int
        get() = memberAt<IntVar>(104).konstue
        set(konstue) { memberAt<IntVar>(104).konstue = konstue }
    
    var attributes: CPointer<CPointerVar<CXIdxAttrInfo>>?
        get() = memberAt<CPointerVar<CPointerVar<CXIdxAttrInfo>>>(112).konstue
        set(konstue) { memberAt<CPointerVar<CPointerVar<CXIdxAttrInfo>>>(112).konstue = konstue }
    
    var numAttributes: Int
        get() = memberAt<IntVar>(120).konstue
        set(konstue) { memberAt<IntVar>(120).konstue = konstue }
    
    var flags: Int
        get() = memberAt<IntVar>(124).konstue
        set(konstue) { memberAt<IntVar>(124).konstue = konstue }
}
...
class CXIdxObjCContainerDeclInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var declInfo: CPointer<CXIdxDeclInfo>?
        get() = memberAt<CPointerVar<CXIdxDeclInfo>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxDeclInfo>>(0).konstue = konstue }
    
    var kind: CXIdxObjCContainerKind
        get() = memberAt<CXIdxObjCContainerKindVar>(8).konstue
        set(konstue) { memberAt<CXIdxObjCContainerKindVar>(8).konstue = konstue }
}
...
class CXIdxObjCProtocolRefListInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var protocols: CPointer<CPointerVar<CXIdxObjCProtocolRefInfo>>?
        get() = memberAt<CPointerVar<CPointerVar<CXIdxObjCProtocolRefInfo>>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CPointerVar<CXIdxObjCProtocolRefInfo>>>(0).konstue = konstue }
...
class CXIdxObjCInterfaceDeclInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var containerInfo: CPointer<CXIdxObjCContainerDeclInfo>?
        get() = memberAt<CPointerVar<CXIdxObjCContainerDeclInfo>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxObjCContainerDeclInfo>>(0).konstue = konstue }
    
    var superInfo: CPointer<CXIdxBaseClassInfo>?
        get() = memberAt<CPointerVar<CXIdxBaseClassInfo>>(8).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxBaseClassInfo>>(8).konstue = konstue }
    
    var protocols: CPointer<CXIdxObjCProtocolRefListInfo>?
        get() = memberAt<CPointerVar<CXIdxObjCProtocolRefListInfo>>(16).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxObjCProtocolRefListInfo>>(16).konstue = konstue }
}
...
class CXIdxObjCCategoryDeclInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var protocols: CPointer<CXIdxObjCProtocolRefListInfo>?
        get() = memberAt<CPointerVar<CXIdxObjCProtocolRefListInfo>>(72).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxObjCProtocolRefListInfo>>(72).konstue = konstue }
}
...
class CXIdxObjCPropertyDeclInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var setter: CPointer<CXIdxEntityInfo>?
        get() = memberAt<CPointerVar<CXIdxEntityInfo>>(16).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxEntityInfo>>(16).konstue = konstue }
}
...
class CXIdxCXXClassDeclInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var bases: CPointer<CPointerVar<CXIdxBaseClassInfo>>?
        get() = memberAt<CPointerVar<CPointerVar<CXIdxBaseClassInfo>>>(8).konstue
        set(konstue) { memberAt<CPointerVar<CPointerVar<CXIdxBaseClassInfo>>>(8).konstue = konstue }
...
class CXIdxEntityRefInfo(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var kind: CXIdxEntityRefKind
        get() = memberAt<CXIdxEntityRefKindVar>(0).konstue
        set(konstue) { memberAt<CXIdxEntityRefKindVar>(0).konstue = konstue }
    ...
    var referencedEntity: CPointer<CXIdxEntityInfo>?
        get() = memberAt<CPointerVar<CXIdxEntityInfo>>(64).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxEntityInfo>>(64).konstue = konstue }
    
    var parentEntity: CPointer<CXIdxEntityInfo>?
        get() = memberAt<CPointerVar<CXIdxEntityInfo>>(72).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxEntityInfo>>(72).konstue = konstue }
    
    var container: CPointer<CXIdxContainerInfo>?
        get() = memberAt<CPointerVar<CXIdxContainerInfo>>(80).konstue
        set(konstue) { memberAt<CPointerVar<CXIdxContainerInfo>>(80).konstue = konstue }
    
    var role: CXSymbolRole
        get() = memberAt<CXSymbolRoleVar>(88).konstue
        set(konstue) { memberAt<CXSymbolRoleVar>(88).konstue = konstue }
}
...
class IndexerCallbacks(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var abortQuery: CPointer<CFunction<(CXClientData?, COpaquePointer?) -> Int>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, COpaquePointer?) -> Int>>>(0).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, COpaquePointer?) -> Int>>>(0).konstue = konstue }
    
    var diagnostic: CPointer<CFunction<(CXClientData?, CXDiagnosticSet?, COpaquePointer?) -> Unit>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, CXDiagnosticSet?, COpaquePointer?) -> Unit>>>(8).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, CXDiagnosticSet?, COpaquePointer?) -> Unit>>>(8).konstue = konstue }
    
    var enteredMainFile: CPointer<CFunction<(CXClientData?, CXFile?, COpaquePointer?) -> CXIdxClientFile?>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, CXFile?, COpaquePointer?) -> CXIdxClientFile?>>>(16).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, CXFile?, COpaquePointer?) -> CXIdxClientFile?>>>(16).konstue = konstue }
    
    var ppIncludedFile: CPointer<CFunction<(CXClientData?, CPointer<CXIdxIncludedFileInfo>?) -> CXIdxClientFile?>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxIncludedFileInfo>?) -> CXIdxClientFile?>>>(24).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxIncludedFileInfo>?) -> CXIdxClientFile?>>>(24).konstue = konstue }
    
    var importedASTFile: CPointer<CFunction<(CXClientData?, CPointer<CXIdxImportedASTFileInfo>?) -> CXIdxClientASTFile?>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxImportedASTFileInfo>?) -> CXIdxClientASTFile?>>>(32).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxImportedASTFileInfo>?) -> CXIdxClientASTFile?>>>(32).konstue = konstue }
    
    var startedTranslationUnit: CPointer<CFunction<(CXClientData?, COpaquePointer?) -> CXIdxClientContainer?>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, COpaquePointer?) -> CXIdxClientContainer?>>>(40).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, COpaquePointer?) -> CXIdxClientContainer?>>>(40).konstue = konstue }
    
    var indexDeclaration: CPointer<CFunction<(CXClientData?, CPointer<CXIdxDeclInfo>?) -> Unit>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxDeclInfo>?) -> Unit>>>(48).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxDeclInfo>?) -> Unit>>>(48).konstue = konstue }
    
    var indexEntityReference: CPointer<CFunction<(CXClientData?, CPointer<CXIdxEntityRefInfo>?) -> Unit>>?
        get() = memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxEntityRefInfo>?) -> Unit>>>(56).konstue
        set(konstue) { memberAt<CPointerVar<CFunction<(CXClientData?, CPointer<CXIdxEntityRefInfo>?) -> Unit>>>(56).konstue = konstue }
}
...
enum class CXErrorCode(konstue: Int) : CEnum {
    CXError_Success(0),
    CXError_Failure(1),
    CXError_Crashed(2),
    CXError_InkonstidArguments(3),
    ...
    companion object {
        ...
        fun byValue(konstue: Int): CXErrorCode = konstues().find { it.konstue == konstue }!!
    }
    
    override open konst konstue: Int = konstue
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        ...
        var konstue: CXErrorCode
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXAvailabilityKind(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXAvailabilityKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXAvailabilityKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXCursor_ExceptionSpecificationKind(konstue: Int) : CEnum {
    ...
    CXCursor_ExceptionSpecificationKind_Unekonstuated(6),
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXCursor_ExceptionSpecificationKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXCursor_ExceptionSpecificationKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXDiagnosticSeverity(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXDiagnosticSeverity = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXDiagnosticSeverity
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXLoadDiag_Error(konstue: Int) : CEnum {
    CXLoadDiag_None(0),
    CXLoadDiag_Unknown(1),
    CXLoadDiag_CannotLoad(2),
    CXLoadDiag_InkonstidFile(3),
    ;
    
    companion object {
        
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXLoadDiag_Error = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXLoadDiag_Error
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXSaveError(konstue: Int) : CEnum {
    CXSaveError_None(0),
    CXSaveError_Unknown(1),
    CXSaveError_TranslationErrors(2),
    CXSaveError_InkonstidTU(3),
    ;
    
    companion object {
        
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXSaveError = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXSaveError
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXTUResourceUsageKind(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        konst CXTUResourceUsage_MEMORY_IN_BYTES_BEGIN: CXTUResourceUsageKind
            get() = CXTUResourceUsage_AST
        
        konst CXTUResourceUsage_First: CXTUResourceUsageKind
            get() = CXTUResourceUsage_AST
        
        konst CXTUResourceUsage_MEMORY_IN_BYTES_END: CXTUResourceUsageKind
            get() = CXTUResourceUsage_Preprocessor_HeaderSearch
        
        konst CXTUResourceUsage_Last: CXTUResourceUsageKind
            get() = CXTUResourceUsage_Preprocessor_HeaderSearch
        
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXTUResourceUsageKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXTUResourceUsageKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXCursorKind(konstue: Int) : CEnum {
    ...
    CXCursor_InkonstidFile(70),
    CXCursor_NoDeclFound(71),
    CXCursor_NotImplemented(72),
    CXCursor_InkonstidCode(73),
    ...
    companion object {
        ...
        konst CXCursor_FirstDecl: CXCursorKind
            get() = CXCursor_UnexposedDecl
        
        konst CXCursor_LastDecl: CXCursorKind
            get() = CXCursor_CXXAccessSpecifier
        
        konst CXCursor_FirstRef: CXCursorKind
            get() = CXCursor_ObjCSuperClassRef
        
        konst CXCursor_LastRef: CXCursorKind
            get() = CXCursor_VariableRef
        
        konst CXCursor_FirstInkonstid: CXCursorKind
            get() = CXCursor_InkonstidFile
        
        konst CXCursor_LastInkonstid: CXCursorKind
            get() = CXCursor_InkonstidCode
        
        konst CXCursor_FirstExpr: CXCursorKind
            get() = CXCursor_UnexposedExpr
        
        konst CXCursor_LastExpr: CXCursorKind
            get() = CXCursor_CXXAddrspaceCastExpr
        
        konst CXCursor_FirstStmt: CXCursorKind
            get() = CXCursor_UnexposedStmt
        
        konst CXCursor_AsmStmt: CXCursorKind
            get() = CXCursor_GCCAsmStmt
        
        konst CXCursor_LastStmt: CXCursorKind
            get() = CXCursor_OMPScanDirective
        
        konst CXCursor_FirstAttr: CXCursorKind
            get() = CXCursor_UnexposedAttr
        
        konst CXCursor_LastAttr: CXCursorKind
            get() = CXCursor_AlignedAttr
        
        konst CXCursor_FirstPreprocessing: CXCursorKind
            get() = CXCursor_PreprocessingDirective
        
        konst CXCursor_MacroInstantiation: CXCursorKind
            get() = CXCursor_MacroExpansion
        
        konst CXCursor_LastPreprocessing: CXCursorKind
            get() = CXCursor_InclusionDirective
        
        konst CXCursor_FirstExtraDecl: CXCursorKind
            get() = CXCursor_ModuleImportDecl
        
        konst CXCursor_FriendDecl: CXCursorKind
            get() = CXCursor_LastExtraDecl
        
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXCursorKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXCursorKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXLinkageKind(konstue: Int) : CEnum {
    CXLinkage_Inkonstid(0),
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXLinkageKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXLinkageKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXVisibilityKind(konstue: Int) : CEnum {
    CXVisibility_Inkonstid(0),
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXVisibilityKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXVisibilityKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXLanguageKind(konstue: Int) : CEnum {
    CXLanguage_Inkonstid(0),
    CXLanguage_C(1),
    CXLanguage_ObjC(2),
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXLanguageKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXLanguageKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXTypeKind(konstue: Int) : CEnum {
    CXType_Inkonstid(0),
    CXType_Unexposed(1),
    CXType_Void(2),
    CXType_Bool(3),
    ...
    companion object {
        ...
        konst CXType_FirstBuiltin: CXTypeKind
            get() = CXType_Void
        
        konst CXType_LastBuiltin: CXTypeKind
            get() = CXType_BFloat16
        
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXTypeKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXTypeKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXCallingConv(konstue: Int) : CEnum {
    ...
    CXCallingConv_Inkonstid(100),
    CXCallingConv_Unexposed(200),
    ;
    
    companion object {
        
        konst CXCallingConv_X86_64Win64: CXCallingConv
            get() = CXCallingConv_Win64
        
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXCallingConv = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXCallingConv
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXTemplateArgumentKind(konstue: Int) : CEnum {
    ...
    CXTemplateArgumentKind_Inkonstid(9),
    ;
    
    companion object {
        
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXTemplateArgumentKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXTemplateArgumentKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CX_CXXAccessSpecifier(konstue: Int) : CEnum {
    CX_CXXInkonstidAccessSpecifier(0),
    CX_CXXPublic(1),
    CX_CXXProtected(2),
    CX_CXXPrivate(3),
    ;
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CX_CXXAccessSpecifier = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CX_CXXAccessSpecifier
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CX_StorageClass(konstue: Int) : CEnum {
    CX_SC_Inkonstid(0),
    CX_SC_None(1),
    CX_SC_Extern(2),
    CX_SC_Static(3),
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CX_StorageClass = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CX_StorageClass
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXChildVisitResult(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXChildVisitResult = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXChildVisitResult
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXTokenKind(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXTokenKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXTokenKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXCompletionChunkKind(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXCompletionChunkKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXCompletionChunkKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXEkonstResultKind(konstue: Int) : CEnum {
    CXEkonst_UnExposed(0),
    CXEkonst_Int(1),
    CXEkonst_Float(2),
    CXEkonst_ObjCStrLiteral(3),
    CXEkonst_StrLiteral(4),
    CXEkonst_CFStr(5),
    CXEkonst_Other(6),
    ;
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXEkonstResultKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXEkonstResultKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXVisitorResult(konstue: Int) : CEnum {
    CXVisit_Break(0),
    CXVisit_Continue(1),
    ;
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXVisitorResult = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXVisitorResult
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXResult(konstue: Int) : CEnum {
    CXResult_Success(0),
    CXResult_Inkonstid(1),
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXResult = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXResult
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXIdxEntityKind(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXIdxEntityKind = konstues().find { it.konstue == konstue }!!
    }
    ...
    class Var(rawPtr: NativePtr) : CEnumVar(rawPtr) {
        @Deprecated("Use sizeOf<T>() or alignOf<T>() instead.")
        companion object : Type(sizeOf<IntVar>().toInt())
        var konstue: CXIdxEntityKind
            get() = byValue(this.reinterpret<IntVar>().konstue)
            set(konstue) { this.reinterpret<IntVar>().konstue = konstue.konstue }
    }
}

enum class CXNullabilityKind(konstue: Int) : CEnum {
    ...
    companion object {
        ...
        @Deprecated("Will be removed.", ReplaceWith(""), DeprecationLevel.WARNING)
        fun byValue(konstue: Int): CXNullabilityKind = konstues().find { it.konstue == konstue }!!
    }
...
fun clang_getFileName(SFile: CXFile?): CValue<CXString> {
    konst kniRetVal = nativeHeap.alloc<CXString>()
    try {
...
fun clang_getNullLocation(): CValue<CXSourceLocation> {
    konst kniRetVal = nativeHeap.alloc<CXSourceLocation>()
    try {
...
fun clang_getNullRange(): CValue<CXSourceRange> {
    konst kniRetVal = nativeHeap.alloc<CXSourceRange>()
    try {
...
fun clang_getTUResourceUsageName(kind: CXTUResourceUsageKind): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge84(kind.konstue))
}

fun clang_getCXTUResourceUsage(TU: CXTranslationUnit?): CValue<CXTUResourceUsage> {
    konst kniRetVal = nativeHeap.alloc<CXTUResourceUsage>()
    try {
...
fun clang_getNullCursor(): CValue<CXCursor> {
    konst kniRetVal = nativeHeap.alloc<CXCursor>()
    try {
...
fun clang_isDeclaration(arg0: CXCursorKind): Int {
    return kniBridge97(arg0.konstue)
}

fun clang_isInkonstidDeclaration(arg0: CValue<CXCursor>): Int {
    memScoped {
...
fun clang_isInkonstid(arg0: CXCursorKind): Int {
    return kniBridge104(arg0.konstue)
}

fun clang_isTranslationUnit(arg0: CXCursorKind): Int {
    return kniBridge105(arg0.konstue)
}

fun clang_isPreprocessing(arg0: CXCursorKind): Int {
    return kniBridge106(arg0.konstue)
}

fun clang_isUnexposed(arg0: CXCursorKind): Int {
    return kniBridge107(arg0.konstue)
}
...
fun clang_getCursorType(C: CValue<CXCursor>): CValue<CXType> {
    memScoped {
        konst kniRetVal = nativeHeap.alloc<CXType>()
        try {
...
fun clang_getTypeKindSpelling(K: CXTypeKind): CValue<CXString> {
    konst kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge156(K.konstue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_getCursorKindSpelling(Kind: CXCursorKind): CValue<CXString> {
    konst kniRetVal = nativeHeap.alloc<CXString>()
    try {
        kniBridge266(Kind.konstue, kniRetVal.rawPtr)
        return kniRetVal.readValue()
    } finally { nativeHeap.free(kniRetVal) }
}
...
fun clang_Cursor_Ekonstuate(C: CValue<CXCursor>): CXEkonstResult? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge296(C.getPointer(memScope).rawValue))
    }
}

fun clang_EkonstResult_getKind(E: CXEkonstResult?): CXEkonstResultKind {
    return CXEkonstResultKind.byValue(kniBridge297(E.rawValue))
}

fun clang_EkonstResult_getAsInt(E: CXEkonstResult?): Int {
    return kniBridge298(E.rawValue)
}

fun clang_EkonstResult_getAsLongLong(E: CXEkonstResult?): Long {
    return kniBridge299(E.rawValue)
}

fun clang_EkonstResult_isUnsignedInt(E: CXEkonstResult?): Int {
    return kniBridge300(E.rawValue)
}

fun clang_EkonstResult_getAsUnsigned(E: CXEkonstResult?): Long {
    return kniBridge301(E.rawValue)
}

fun clang_EkonstResult_getAsDouble(E: CXEkonstResult?): Double {
    return kniBridge302(E.rawValue)
}

fun clang_EkonstResult_getAsStr(E: CXEkonstResult?): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge303(E.rawValue))
}

fun clang_EkonstResult_dispose(E: CXEkonstResult?): Unit {
...
fun clang_index_isEntityObjCContainerKind(arg0: CXIdxEntityKind): Int {
    return kniBridge312(arg0.konstue)
}
...
fun clang_getDeclTypeAttributes(cursor: CValue<CXCursor>): CValue<CXTypeAttributes> {
    memScoped {
        konst kniRetVal = nativeHeap.alloc<CXTypeAttributes>()
        try {
...
konst CINDEX_VERSION_MAJOR: Int get() = 0

konst CINDEX_VERSION_MINOR: Int get() = 61

konst CINDEX_VERSION: Int get() = 61

konst CINDEX_VERSION_STRING: String get() = "0.61"
...
typealias CXEkonstResultVar = CPointerVarOf<CXEkonstResult>

typealias CXEkonstResult = COpaquePointer
...
konst CXGlobalOpt_None: CXGlobalOptFlags get() = 0

konst CXGlobalOpt_ThreadBackgroundPriorityForIndexing: CXGlobalOptFlags get() = 1

konst CXGlobalOpt_ThreadBackgroundPriorityForEditing: CXGlobalOptFlags get() = 2

konst CXGlobalOpt_ThreadBackgroundPriorityForAll: CXGlobalOptFlags get() = 3
...
konst CXDiagnostic_DisplaySourceLocation: CXDiagnosticDisplayOptions get() = 1

konst CXDiagnostic_DisplayColumn: CXDiagnosticDisplayOptions get() = 2

konst CXDiagnostic_DisplaySourceRanges: CXDiagnosticDisplayOptions get() = 4

konst CXDiagnostic_DisplayOption: CXDiagnosticDisplayOptions get() = 8

konst CXDiagnostic_DisplayCategoryId: CXDiagnosticDisplayOptions get() = 16

konst CXDiagnostic_DisplayCategoryName: CXDiagnosticDisplayOptions get() = 32
...
konst CXTranslationUnit_None: CXTranslationUnit_Flags get() = 0

konst CXTranslationUnit_DetailedPreprocessingRecord: CXTranslationUnit_Flags get() = 1

konst CXTranslationUnit_Incomplete: CXTranslationUnit_Flags get() = 2

konst CXTranslationUnit_PrecompiledPreamble: CXTranslationUnit_Flags get() = 4

konst CXTranslationUnit_CacheCompletionResults: CXTranslationUnit_Flags get() = 8

konst CXTranslationUnit_ForSerialization: CXTranslationUnit_Flags get() = 16

konst CXTranslationUnit_CXXChainedPCH: CXTranslationUnit_Flags get() = 32

konst CXTranslationUnit_SkipFunctionBodies: CXTranslationUnit_Flags get() = 64

konst CXTranslationUnit_IncludeBriefCommentsInCodeCompletion: CXTranslationUnit_Flags get() = 128

konst CXTranslationUnit_CreatePreambleOnFirstParse: CXTranslationUnit_Flags get() = 256

konst CXTranslationUnit_KeepGoing: CXTranslationUnit_Flags get() = 512

konst CXTranslationUnit_SingleFileParse: CXTranslationUnit_Flags get() = 1024

konst CXTranslationUnit_LimitSkipFunctionBodiesToPreamble: CXTranslationUnit_Flags get() = 2048

konst CXTranslationUnit_IncludeAttributedTypes: CXTranslationUnit_Flags get() = 4096

konst CXTranslationUnit_VisitImplicitAttributes: CXTranslationUnit_Flags get() = 8192

konst CXTranslationUnit_IgnoreNonErrorsFromIncludedFiles: CXTranslationUnit_Flags get() = 16384

konst CXTranslationUnit_RetainExcludedConditionalBlocks: CXTranslationUnit_Flags get() = 32768
...
konst CXSaveTranslationUnit_None: CXSaveTranslationUnit_Flags get() = 0
...
konst CXReparse_None: CXReparse_Flags get() = 0
...
konst CXTLS_None: CXTLSKind get() = 0

konst CXTLS_Dynamic: CXTLSKind get() = 1

konst CXTLS_Static: CXTLSKind get() = 2
...
konst CXTypeNullability_NonNull: CXTypeNullabilityKind get() = 0

konst CXTypeNullability_Nullable: CXTypeNullabilityKind get() = 1

konst CXTypeNullability_Unspecified: CXTypeNullabilityKind get() = 2

konst CXTypeNullability_Inkonstid: CXTypeNullabilityKind get() = 3
...
konst CXTypeLayoutError_Inkonstid: CXTypeLayoutError get() = -1

konst CXTypeLayoutError_Incomplete: CXTypeLayoutError get() = -2

konst CXTypeLayoutError_Dependent: CXTypeLayoutError get() = -3

konst CXTypeLayoutError_NotConstantSize: CXTypeLayoutError get() = -4

konst CXTypeLayoutError_InkonstidFieldName: CXTypeLayoutError get() = -5

konst CXTypeLayoutError_Undeduced: CXTypeLayoutError get() = -6
...
konst CXRefQualifier_None: CXRefQualifierKind get() = 0

konst CXRefQualifier_LValue: CXRefQualifierKind get() = 1

konst CXRefQualifier_RValue: CXRefQualifierKind get() = 2
...
konst CXPrintingPolicy_Indentation: CXPrintingPolicyProperty get() = 0

konst CXPrintingPolicy_SuppressSpecifiers: CXPrintingPolicyProperty get() = 1

konst CXPrintingPolicy_SuppressTagKeyword: CXPrintingPolicyProperty get() = 2

konst CXPrintingPolicy_IncludeTagDefinition: CXPrintingPolicyProperty get() = 3

konst CXPrintingPolicy_SuppressScope: CXPrintingPolicyProperty get() = 4

konst CXPrintingPolicy_SuppressUnwrittenScope: CXPrintingPolicyProperty get() = 5

konst CXPrintingPolicy_SuppressInitializers: CXPrintingPolicyProperty get() = 6

konst CXPrintingPolicy_ConstantArraySizeAsWritten: CXPrintingPolicyProperty get() = 7

konst CXPrintingPolicy_AnonymousTagLocations: CXPrintingPolicyProperty get() = 8

konst CXPrintingPolicy_SuppressStrongLifetime: CXPrintingPolicyProperty get() = 9

konst CXPrintingPolicy_SuppressLifetimeQualifiers: CXPrintingPolicyProperty get() = 10

konst CXPrintingPolicy_SuppressTemplateArgsInCXXConstructors: CXPrintingPolicyProperty get() = 11

konst CXPrintingPolicy_Bool: CXPrintingPolicyProperty get() = 12

konst CXPrintingPolicy_Restrict: CXPrintingPolicyProperty get() = 13

konst CXPrintingPolicy_Alignof: CXPrintingPolicyProperty get() = 14

konst CXPrintingPolicy_UnderscoreAlignof: CXPrintingPolicyProperty get() = 15

konst CXPrintingPolicy_UseVoidForZeroParams: CXPrintingPolicyProperty get() = 16

konst CXPrintingPolicy_TerseOutput: CXPrintingPolicyProperty get() = 17

konst CXPrintingPolicy_PolishForDeclaration: CXPrintingPolicyProperty get() = 18

konst CXPrintingPolicy_Half: CXPrintingPolicyProperty get() = 19

konst CXPrintingPolicy_MSWChar: CXPrintingPolicyProperty get() = 20

konst CXPrintingPolicy_IncludeNewlines: CXPrintingPolicyProperty get() = 21

konst CXPrintingPolicy_MSVCFormatting: CXPrintingPolicyProperty get() = 22

konst CXPrintingPolicy_ConstantsAsWritten: CXPrintingPolicyProperty get() = 23

konst CXPrintingPolicy_SuppressImplicitBase: CXPrintingPolicyProperty get() = 24

konst CXPrintingPolicy_FullyQualifiedName: CXPrintingPolicyProperty get() = 25

konst CXPrintingPolicy_LastProperty: CXPrintingPolicyProperty get() = 25
...
konst CXObjCPropertyAttr_noattr: CXObjCPropertyAttrKind get() = 0

konst CXObjCPropertyAttr_readonly: CXObjCPropertyAttrKind get() = 1

konst CXObjCPropertyAttr_getter: CXObjCPropertyAttrKind get() = 2

konst CXObjCPropertyAttr_assign: CXObjCPropertyAttrKind get() = 4

konst CXObjCPropertyAttr_readwrite: CXObjCPropertyAttrKind get() = 8

konst CXObjCPropertyAttr_retain: CXObjCPropertyAttrKind get() = 16

konst CXObjCPropertyAttr_copy: CXObjCPropertyAttrKind get() = 32

konst CXObjCPropertyAttr_nonatomic: CXObjCPropertyAttrKind get() = 64

konst CXObjCPropertyAttr_setter: CXObjCPropertyAttrKind get() = 128

konst CXObjCPropertyAttr_atomic: CXObjCPropertyAttrKind get() = 256

konst CXObjCPropertyAttr_weak: CXObjCPropertyAttrKind get() = 512

konst CXObjCPropertyAttr_strong: CXObjCPropertyAttrKind get() = 1024

konst CXObjCPropertyAttr_unsafe_unretained: CXObjCPropertyAttrKind get() = 2048

konst CXObjCPropertyAttr_class: CXObjCPropertyAttrKind get() = 4096
...
konst CXObjCDeclQualifier_None: CXObjCDeclQualifierKind get() = 0

konst CXObjCDeclQualifier_In: CXObjCDeclQualifierKind get() = 1

konst CXObjCDeclQualifier_Inout: CXObjCDeclQualifierKind get() = 2

konst CXObjCDeclQualifier_Out: CXObjCDeclQualifierKind get() = 4

konst CXObjCDeclQualifier_Bycopy: CXObjCDeclQualifierKind get() = 8

konst CXObjCDeclQualifier_Byref: CXObjCDeclQualifierKind get() = 16

konst CXObjCDeclQualifier_Oneway: CXObjCDeclQualifierKind get() = 32
...
konst CXNameRange_WantQualifier: CXNameRefFlags get() = 1

konst CXNameRange_WantTemplateArgs: CXNameRefFlags get() = 2

konst CXNameRange_WantSinglePiece: CXNameRefFlags get() = 4
...
konst CXCodeComplete_IncludeMacros: CXCodeComplete_Flags get() = 1

konst CXCodeComplete_IncludeCodePatterns: CXCodeComplete_Flags get() = 2

konst CXCodeComplete_IncludeBriefComments: CXCodeComplete_Flags get() = 4

konst CXCodeComplete_SkipPreamble: CXCodeComplete_Flags get() = 8

konst CXCodeComplete_IncludeCompletionsWithFixIts: CXCodeComplete_Flags get() = 16
...
konst CXCompletionContext_Unexposed: CXCompletionContext get() = 0

konst CXCompletionContext_AnyType: CXCompletionContext get() = 1

konst CXCompletionContext_AnyValue: CXCompletionContext get() = 2

konst CXCompletionContext_ObjCObjectValue: CXCompletionContext get() = 4

konst CXCompletionContext_ObjCSelectorValue: CXCompletionContext get() = 8

konst CXCompletionContext_CXXClassTypeValue: CXCompletionContext get() = 16

konst CXCompletionContext_DotMemberAccess: CXCompletionContext get() = 32

konst CXCompletionContext_ArrowMemberAccess: CXCompletionContext get() = 64

konst CXCompletionContext_ObjCPropertyAccess: CXCompletionContext get() = 128

konst CXCompletionContext_EnumTag: CXCompletionContext get() = 256

konst CXCompletionContext_UnionTag: CXCompletionContext get() = 512

konst CXCompletionContext_StructTag: CXCompletionContext get() = 1024

konst CXCompletionContext_ClassTag: CXCompletionContext get() = 2048

konst CXCompletionContext_Namespace: CXCompletionContext get() = 4096

konst CXCompletionContext_NestedNameSpecifier: CXCompletionContext get() = 8192

konst CXCompletionContext_ObjCInterface: CXCompletionContext get() = 16384

konst CXCompletionContext_ObjCProtocol: CXCompletionContext get() = 32768

konst CXCompletionContext_ObjCCategory: CXCompletionContext get() = 65536

konst CXCompletionContext_ObjCInstanceMessage: CXCompletionContext get() = 131072

konst CXCompletionContext_ObjCClassMessage: CXCompletionContext get() = 262144

konst CXCompletionContext_ObjCSelectorName: CXCompletionContext get() = 524288

konst CXCompletionContext_MacroName: CXCompletionContext get() = 1048576

konst CXCompletionContext_NaturalLanguage: CXCompletionContext get() = 2097152

konst CXCompletionContext_IncludedFile: CXCompletionContext get() = 4194304

konst CXCompletionContext_Unknown: CXCompletionContext get() = 8388607
...
konst CXIdxEntityLang_None: CXIdxEntityLanguage get() = 0

konst CXIdxEntityLang_C: CXIdxEntityLanguage get() = 1

konst CXIdxEntityLang_ObjC: CXIdxEntityLanguage get() = 2

konst CXIdxEntityLang_CXX: CXIdxEntityLanguage get() = 3

konst CXIdxEntityLang_Swift: CXIdxEntityLanguage get() = 4
...
konst CXIdxEntity_NonTemplate: CXIdxEntityCXXTemplateKind get() = 0

konst CXIdxEntity_Template: CXIdxEntityCXXTemplateKind get() = 1

konst CXIdxEntity_TemplatePartialSpecialization: CXIdxEntityCXXTemplateKind get() = 2

konst CXIdxEntity_TemplateSpecialization: CXIdxEntityCXXTemplateKind get() = 3
...
konst CXIdxAttr_Unexposed: CXIdxAttrKind get() = 0

konst CXIdxAttr_IBAction: CXIdxAttrKind get() = 1

konst CXIdxAttr_IBOutlet: CXIdxAttrKind get() = 2

konst CXIdxAttr_IBOutletCollection: CXIdxAttrKind get() = 3
...
konst CXIdxDeclFlag_Skipped: CXIdxDeclInfoFlags get() = 1
...
konst CXIdxObjCContainer_ForwardRef: CXIdxObjCContainerKind get() = 0

konst CXIdxObjCContainer_Interface: CXIdxObjCContainerKind get() = 1

konst CXIdxObjCContainer_Implementation: CXIdxObjCContainerKind get() = 2
...
konst CXIdxEntityRef_Direct: CXIdxEntityRefKind get() = 1

konst CXIdxEntityRef_Implicit: CXIdxEntityRefKind get() = 2
...
konst CXSymbolRole_None: CXSymbolRole get() = 0

konst CXSymbolRole_Declaration: CXSymbolRole get() = 1

konst CXSymbolRole_Definition: CXSymbolRole get() = 2

konst CXSymbolRole_Reference: CXSymbolRole get() = 4

konst CXSymbolRole_Read: CXSymbolRole get() = 8

konst CXSymbolRole_Write: CXSymbolRole get() = 16

konst CXSymbolRole_Call: CXSymbolRole get() = 32

konst CXSymbolRole_Dynamic: CXSymbolRole get() = 64

konst CXSymbolRole_AddressOf: CXSymbolRole get() = 128

konst CXSymbolRole_Implicit: CXSymbolRole get() = 256
...
konst CXIndexOpt_None: CXIndexOptFlags get() = 0

konst CXIndexOpt_SuppressRedundantRefs: CXIndexOptFlags get() = 1

konst CXIndexOpt_IndexFunctionLocalSymbols: CXIndexOptFlags get() = 2

konst CXIndexOpt_IndexImplicitTemplateInstantiations: CXIndexOptFlags get() = 4

konst CXIndexOpt_SuppressWarnings: CXIndexOptFlags get() = 8

konst CXIndexOpt_SkipParsedBodiesInSession: CXIndexOptFlags get() = 16
...
private konst loadLibrary = loadKonanLibrary("clangstubs")
