...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)resumeValue:(id _Nullable)konstue __attribute__((swift_name("resume(konstue:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)unitValue:(id _Nullable)konstue completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("unit(konstue:completionHandler:)")));
 ...
 * @note This method converts all Kotlin exceptions to errors.
*/
- (void)nothingAsUnitValue:(id _Nullable)konstue completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("nothingAsUnit(konstue:completionHandler:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)unitValue:(KtInt *)konstue completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("unit(konstue:completionHandler:)")));
 ...
 * @note This method converts all Kotlin exceptions to errors.
*/
- (void)nothingAsUnitValue:(KtInt *)konstue completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("nothingAsUnit(konstue:completionHandler:)")));
@end
...
+ (KtKotlinWeakReference *)createWeakReferenceValue:(id)konstue __attribute__((swift_name("createWeakReference(konstue:)")));
...
+ (KtKotlinArray *)konstues __attribute__((swift_name("konstues()")));
...
- (instancetype)initWithValue:(id _Nullable)konstue __attribute__((swift_name("init(konstue:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id _Nullable konstue __attribute__((swift_name("konstue")));
@end
...
- (void)setValueThisRef:(KtKotlinNothing * _Nullable)thisRef property:(id<KtKotlinKProperty>)property konstue:(KtKotlinArray *)konstue __attribute__((swift_name("setValue(thisRef:property:konstue:)")));
@end
...
@interface KtTestInkonstidIdentifiersE : KtKotlinEnum
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
