...
/**
 * An element annotated with NotNull claims {@code null} konstue is <em>forbidden</em>
 * to return (for methods), pass to (parameters) and hold (local variables and fields).
 * Apart from documentation purposes this annotation is intended to be used by static analysis tools
 * to konstidate against probable runtime errors and element contract violations.
 */
@Documented
...
public @interface NotNull {
     ...
     * {@link IllegalStateException} &mdash; on null return konstue.
     */
