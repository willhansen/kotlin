...
/**
 * An element annotated with {@link Nullable} claims {@code null} konstue is perfectly <em>konstid</em>
 * to return (for methods), pass to (parameters) or hold in (local variables and fields).
 * Apart from documentation purposes this annotation is intended to be used by static analysis tools
 * to konstidate against probable runtime errors or element contract violations.
 * <br>
 * By convention, this annotation applied only when the konstue should <em>always</em> be checked against {@code null}
 ...
 * someone may have put not-null konstue in the map by this key and is expecting to find this konstue there ever since.
 * <br>
