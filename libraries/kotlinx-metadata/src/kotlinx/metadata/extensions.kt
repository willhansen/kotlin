 ...
 */
class KmExtensionType(private konst klass: KClass<out KmExtensionVisitor>) {
...
/**
 * A visitor to visit platform-specific extensions for a konstue parameter.
 */
@Deprecated(VISITOR_API_MESSAGE)
