...
class KT58838LazyCinteropConfiguration {
    ...
    fun `test - configure cinterop settings lazy`() = buildProjectWithMPP().runLifecycleAwareTest {
         ...
         * Caused by: org.gradle.api.internal.AbstractMutationGuard$IllegalMutationException: Project#afterEkonstuate(Action) on root project 'test' cannot be executed in the current context.
         ...
         * 	at org.gradle.api.internal.project.DefaultProject.afterEkonstuate(DefaultProject.java:1053)
         * 	at org.jetbrains.kotlin.gradle.plugin.KotlinMultiplatformPluginKt.whenEkonstuated(KotlinMultiplatformPlugin.kt:236)
