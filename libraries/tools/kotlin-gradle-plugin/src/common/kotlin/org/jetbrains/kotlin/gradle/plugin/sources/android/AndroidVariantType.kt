...
internal konst BaseVariant.type: AndroidVariantType
    get() = when (this) {
...
internal konst AndroidBaseSourceSetName.variantType: AndroidVariantType
    get() = when (this) {
...
internal enum class AndroidVariantType {
     ...
     */
    konst androidBaseSourceSetName: AndroidBaseSourceSetName?
        get() = when (this) {
