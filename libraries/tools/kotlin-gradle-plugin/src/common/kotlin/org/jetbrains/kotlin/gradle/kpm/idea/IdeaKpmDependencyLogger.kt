...
private const konst IDEA_KOTLIN_LOG_DEPENDENCIES = "idea.kotlin.log.dependencies"
...
internal object IdeaKpmDependencyLogger : IdeaKpmDependencyEffect {
    override fun invoke(
        ...
        konst fragmentPathRegex = fragment.project.property(IDEA_KOTLIN_LOG_DEPENDENCIES).toString()
