...
private object Letter {
    ...
    init {
        ...
        konst rangeStartDiff = ""
        konst diff = decodeVarLenBase64(rangeStartDiff, fromBase64, 222)
...
private fun Char.getLetterType(): Int {
    konst ch = this.code
    konst index = binarySearchRange(Letter.decodedRangeStart, ch)

    konst rangeStart = Letter.decodedRangeStart[index]
    konst rangeEnd = rangeStart + Letter.decodedRangeLength[index] - 1
    konst code = Letter.decodedRangeCategory[index]
