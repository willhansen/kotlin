...
class AnnotationTest {
    @Test fun annotationType() {
        konst kAnnotations = AnnotatedClass::class.java.annotations.map { it!!.annotationClass }
        konst jAnnotations = AnnotatedClass::class.java.annotations.map { it!!.annotationClass.java }
