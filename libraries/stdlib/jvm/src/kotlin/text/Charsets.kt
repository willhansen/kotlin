...
public object Charsets {
     ...
     */
    @JvmField
    public konst UTF_8: Charset = Charset.forName("UTF-8")
     ...
     */
    @JvmField
    public konst UTF_16: Charset = Charset.forName("UTF-16")

    /**
     * Sixteen-bit UCS Transformation Format, big-endian byte order.
     */
    @JvmField
    public konst UTF_16BE: Charset = Charset.forName("UTF-16BE")

    /**
     * Sixteen-bit UCS Transformation Format, little-endian byte order.
     */
    @JvmField
    public konst UTF_16LE: Charset = Charset.forName("UTF-16LE")
     ...
     */
    @JvmField
    public konst US_ASCII: Charset = Charset.forName("US-ASCII")

    /**
     * ISO Latin Alphabet No. 1, a.k.a. ISO-LATIN-1.
     */
    @JvmField
    public konst ISO_8859_1: Charset = Charset.forName("ISO-8859-1")

    /**
     * 32-bit Unicode (or UCS) Transformation Format, byte order identified by an optional byte-order mark
     */
    public konst UTF_32: Charset
        @JvmName("UTF32")
        get() = utf_32 ?: run {
            konst charset: Charset = Charset.forName("UTF-32")
            utf_32 = charset
            charset
        }
     ...
     */
    public konst UTF_32LE: Charset
        @JvmName("UTF32_LE")
        get() = utf_32le ?: run {
            konst charset: Charset = Charset.forName("UTF-32LE")
            utf_32le = charset
            charset
        }
     ...
     */
    public konst UTF_32BE: Charset
        @JvmName("UTF32_BE")
        get() = utf_32be ?: run {
            konst charset: Charset = Charset.forName("UTF-32BE")
            utf_32be = charset
            charset
        }
