...
internal inline konst Long.low: Int get() = this.asDynamic().getLowBits().unsafeCast<Int>()
internal inline konst Long.high: Int get() = this.asDynamic().getHighBits().unsafeCast<Int>()
