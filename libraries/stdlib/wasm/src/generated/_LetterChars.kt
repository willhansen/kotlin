...
private konst rangeLength = intArrayOf(
...
private konst rangeCategory = intArrayOf(
...
private fun Char.getLetterType(): Int {
    ...
    konst rangeStart = rangeStart[index]
    konst rangeEnd = rangeStart + rangeLength[index] - 1
    konst code = rangeCategory[index]
