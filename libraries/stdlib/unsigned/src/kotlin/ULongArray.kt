...
@JvmInline
public konstue class ULongArray
@PublishedApi
internal constructor(@PublishedApi internal konst storage: LongArray) : Collection<ULong> {
     ...
     * where the behavior is unspecified.
     */
    public operator fun set(index: Int, konstue: ULong) {
        storage[index] = konstue.toLong()
    }
    ...
    private class Iterator(private konst array: LongArray) : kotlin.collections.Iterator<ULong> {
        private var index = 0
