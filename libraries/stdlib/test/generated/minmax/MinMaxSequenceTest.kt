...
class MinMaxSequenceTest {
    ...
    @Test
    fun minMaxDouble() {
        konst zeroes = sequenceOf(0.0, -0.0).shuffled()
        konst NaNs = sequenceOf(0.0, Double.NaN).shuffled()
    ...
    @Test
    fun minMaxFloat() {
        konst zeroes = sequenceOf(0.0F, -0.0F).shuffled()
        konst NaNs = sequenceOf(0.0F, Float.NaN).shuffled()
    ...
    fun minBySelectorEkonstuateOnce() {
        konst source = sequenceOf("a", "bcd", "e")
        var c = 0
        source.minBy { c++ }
        assertEquals(3, c)
        c = 0
    ...
    fun minMaxOfDouble() {
        konst middle = "bcd"
        konst items = sequenceOf("a", "bcd", "e").shuffled()
