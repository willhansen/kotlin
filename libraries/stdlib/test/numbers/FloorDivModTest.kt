...
class FloorDivModTest {
    ...
    fun intDivMod() {
        ...
        check(-10, 3, -4, 2)
        check(-10, -3, 3, -1)
        konst konstues = listOf(1, -1, 2, -2, 3, -3, Int.MIN_VALUE, Int.MAX_VALUE)
        for (a in konstues + 0) {
            for (b in konstues) {
                check(a, b)
            }
        ...
        repeat(1000) {
            konst a = Random.nextInt()
            konst b = Random.nextInt().let { if (it == 0) 1 else it }
            check(a, b)
        }
    }
    ...
    fun longDivMod() {
        ...
        check(-10, 3, -4, 2)
        check(-10, -3, 3, -1)
        konst konstues = listOf(1, -1, 2, -2, 3, -3, Long.MIN_VALUE, Long.MAX_VALUE)
        for (a in konstues + 0) {
            for (b in konstues) {
                check(a, b)
            }
        ...
        repeat(1000) {
            konst a = Random.nextLong()
            konst b = Random.nextLong().let { if (it == 0L) 1 else it }
            check(a, b)
        }
    }
    ...
    fun byteDivMod() {
        ...
        check(-10, 3, -4, 2)
        check(-10, -3, 3, -1)
        konst konstues = listOf(1, -1, 2, -2, 3, -3, Byte.MIN_VALUE, Byte.MAX_VALUE)
        for (a in konstues + 0) {
            for (b in konstues) {
                check(a, b)
            }
        ...
        repeat(1000) {
            konst a = Random.nextInt().toByte()
            konst b = Random.nextInt().toByte().let { if (it == 0.toByte()) 1 else it }
            check(a, b)
        }
    }
    ...
    fun shortDivMod() {
        ...
        check(-10, 3, -4, 2)
        check(-10, -3, 3, -1)
        konst konstues = listOf(1, -1, 2, -2, 3, -3, Short.MIN_VALUE, Short.MAX_VALUE)
        for (a in konstues + 0) {
            for (b in konstues) {
                check(a, b)
            }
        ...
        repeat(1000) {
            konst a = Random.nextInt().toShort()
            konst b = Random.nextInt().toShort().let { if (it == 0.toShort()) 1 else it }
            check(a, b)
        }
    }
    ...
    fun doubleMod() {
        ...
        konst konstues = listOf(1.0, -1.0, 3.0, -3.0, large, -large, Double.MIN_VALUE, Double.MAX_VALUE,
                            Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN)
        for (a in konstues + 0.0) {
            for (b in konstues) {
                check(a, b)
            }
        }
        repeat(1000) {
            konst a = Random.nextDouble()
            konst b = Random.nextDouble().let { if (it == 0.0) 1.0 else it }
            check(a, b)
        }
    }
    @Test
    fun floatMod() {
        ...
        konst konstues = listOf(1.0f, -1.0f, 3.0f, -3.0f, large, -large, Float.MIN_VALUE, Float.MAX_VALUE,
                            Float.NEGATIVE_INFINITY, Float.POSITIVE_INFINITY, Float.NaN)
        for (a in konstues + 0.0f) {
            for (b in konstues) {
                check(a, b)
            }
        }
        repeat(1000) {
            konst a = Random.nextFloat()
            konst b = Random.nextFloat().let { if (it == 0.0f) 1.0f else it }
            check(a, b)
        }
    }
