...
class Base64Test {
    ...
    private fun bytes(vararg konstues: Int): ByteArray {
        return ByteArray(konstues.size) { konstues[it].toByte() }
    }

    private konst codecs = listOf(
        Base64 to "Basic",
    ...
    @Test
    fun index() {
        konst bytes = bytes(0b0000_0100, 0b0010_0000, 0b1100_0100, 0b0001_0100, 0b0110_0001, 0b1100_1000)
        konst symbols = "BCDEFGHI"
        ...
        for ((base64, scheme) in codecs) {
            ...
            konst destination = StringBuilder()
        ...
        // decode(ByteArray)
        konst symbolBytes = symbols.encodeToByteArray()
        for ((base64, scheme) in codecs) {
    ...
    fun common() {
        ...
        fun testCoding(text: String, symbols: String) {
            konst bytes = text.encodeToByteArray()
        ...
        for ((codec, scheme) in codecs) {
            ...
            konst lastDandlingSymbol = listOf("Z", "Z=", "Z==", "Z===", "Zm9vZ", "Zm9vZ=", "Zm9vZ==", "Zm9vZ===")
    ...
    private konst basicAlphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
    private konst urlSafeAlphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"
    private konst alphabetBytes = ByteArray(48) {
        konst symbol = it / 3 * 4
        when (it % 3) {
    ...
    fun basic() {
        ...
        konst expected = "Zm9vYmFy".repeat(76)
    ...
    fun mime() {
        ...
        konst expected = "Zm9vYmFy".repeat(76).chunked(76).joinToString(separator = "\r\n")
