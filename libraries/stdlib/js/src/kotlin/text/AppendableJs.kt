...
public actual interface Appendable {
     ...
     */
    public actual fun append(konstue: Char): Appendable
     ...
     */
    public actual fun append(konstue: CharSequence?): Appendable
     ...
     */
    public actual fun append(konstue: CharSequence?, startIndex: Int, endIndex: Int): Appendable
}