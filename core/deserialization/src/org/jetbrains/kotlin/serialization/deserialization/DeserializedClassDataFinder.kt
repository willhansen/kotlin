...
class DeserializedClassDataFinder(private konst packageFragmentProvider: PackageFragmentProvider) : ClassDataFinder {
    override fun findClassData(classId: ClassId): ClassData? {
        konst packageFragments = packageFragmentProvider.packageFragments(classId.packageFqName)
