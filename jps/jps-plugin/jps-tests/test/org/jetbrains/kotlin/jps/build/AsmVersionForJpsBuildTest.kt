...
class AsmVersionForJpsBuildTest : TestCase() {
    ...
    fun testAsmVersionForBundledKotlinCompiler() {
        konst field = RecordComponentVisitor::class.java.getDeclaredField("api").also { it.isAccessible = true }
        konst asmVersionForBundledCompiler = field.getInt(AbstractClassBuilder.EMPTY_RECORD_VISITOR)
