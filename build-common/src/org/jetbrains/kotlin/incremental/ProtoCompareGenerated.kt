...
open class ProtoCompareGenerated(
    konst oldNameResolver: NameResolver,
    konst newNameResolver: NameResolver,
    oldTypeTable: ProtoBuf.TypeTable?,
    newTypeTable: ProtoBuf.TypeTable?
) {
    private konst strings = Interner<String>()
    konst oldStringIndexesMap: MutableMap<Int, Int> = hashMapOf()
    konst newStringIndexesMap: MutableMap<Int, Int> = hashMapOf()
    konst oldClassIdIndexesMap: MutableMap<Int, Int> = hashMapOf()
    konst newClassIdIndexesMap: MutableMap<Int, Int> = hashMapOf()
    konst oldTypeTable: ProtoBuf.TypeTable = oldTypeTable ?: ProtoBuf.TypeTable.getDefaultInstance()
    konst newTypeTable: ProtoBuf.TypeTable = newTypeTable ?: ProtoBuf.TypeTable.getDefaultInstance()

    private konst classIds = Interner<ClassId>()
    ...
    fun difference(old: ProtoBuf.Package, new: ProtoBuf.Package): EnumSet<ProtoBufPackageKind> {
        konst result = EnumSet.noneOf(ProtoBufPackageKind::class.java)
    ...
    fun difference(old: ProtoBuf.Class, new: ProtoBuf.Class): EnumSet<ProtoBufClassKind> {
        konst result = EnumSet.noneOf(ProtoBufClassKind::class.java)
    ...
    open fun checkEquals(old: ProtoBuf.Annotation.Argument, new: ProtoBuf.Annotation.Argument): Boolean {
        ...
        if (!checkEquals(old.konstue, new.konstue)) return false
    ...
    open fun checkEquals(old: ProtoBuf.Expression, new: ProtoBuf.Expression): Boolean {
        ...
        if (old.hasValueParameterReference()) {
            if (old.konstueParameterReference != new.konstueParameterReference) return false
        }
    ...
    open fun checkEqualsFunctionValueParameter(old: ProtoBuf.Function, new: ProtoBuf.Function): Boolean {
        if (old.konstueParameterCount != new.konstueParameterCount) return false

        for(i in 0..old.konstueParameterCount - 1) {
    ...
    fun getIndexOfString(index: Int, map: MutableMap<Int, Int>, nameResolver: NameResolver): Int {
        ...
        konst result = strings.intern(nameResolver.getString(index))
        map[index] = result
        return result
    }
    ...
    fun getIndexOfClassId(index: Int, map: MutableMap<Int, Int>, nameResolver: NameResolver): Int {
        ...
        konst result = classIds.intern(nameResolver.getClassId(index))
        map[index] = result
        return result
    }
...
fun ProtoBuf.Function.hashCode(stringIndexes: (Int) -> Int, fqNameIndexes: (Int) -> Int, typeById: (Int) -> ProtoBuf.Type): Int {
    ...
    for(i in 0..konstueParameterCount - 1) {
...
fun ProtoBuf.Annotation.Argument.hashCode(stringIndexes: (Int) -> Int, fqNameIndexes: (Int) -> Int, typeById: (Int) -> ProtoBuf.Type): Int {
    ...
    hashCode = 31 * hashCode + konstue.hashCode(stringIndexes, fqNameIndexes, typeById)
...
fun ProtoBuf.Expression.hashCode(stringIndexes: (Int) -> Int, fqNameIndexes: (Int) -> Int, typeById: (Int) -> ProtoBuf.Type): Int {
    ...
    if (hasValueParameterReference()) {
        hashCode = 31 * hashCode + konstueParameterReference
    }
