...
public abstract class KtResolveExtension {
     ...
     *
     * The content of those files should remain konstid until the tracker [getModificationTracker] is modified.
     *
     * Returned files should contain a konstid Kotlin code.
     *
     * @see KtResolveExtensionFile
    ...
    /**
     * Returns a [ModificationTracker], which controls the konstidity lifecycle of the files provided by [getKtFiles].
     *
     * All files generated by [getKtFiles] should be konstid if the [ModificationTracker] did not change.
     * If files become inkonstid (e.g., the in-source declarations they were based on changed) the [ModificationTracker] should be incremented.
     *
     * @see KtResolveExtension
     */
