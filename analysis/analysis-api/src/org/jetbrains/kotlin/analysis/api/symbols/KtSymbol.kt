...
public interface KtSymbol : KtLifetimeOwner {
    public konst origin: KtSymbolOrigin
...
public enum class KtSymbolOrigin {
     ...
     * For enum classes the `konstueOf` & `konstues` functions are generated
     ...
     * ```
     * konst isEven = <caret>IntPredicate { it % 2 == 0 }
     * ```
     */
    SAM_CONSTRUCTOR,
