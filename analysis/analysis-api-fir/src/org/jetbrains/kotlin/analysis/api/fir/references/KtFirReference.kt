...
interface KtFirReference : KtReference, KtSymbolBasedReference {
    ...
    private fun KtSymbol.getPsiForGeneratedExtensionSymbol(): Collection<PsiElement>? {
        ...
        konst psi = psi ?: return null
        konst ktFile = psi.containingFile as? KtFile ?: return null
        konst psiTargetsProvider = ktFile.virtualFile?.psiTargetsProvider ?: return null
    ...
    private fun KtAnalysisSession.getPsiDeclarations(symbol: KtFirSymbol<*>): Collection<PsiElement> {
        konst intersectionOverriddenSymbolsOrSingle = when {
    ...
    override konst resolver get() = KtFirReferenceResolver
}