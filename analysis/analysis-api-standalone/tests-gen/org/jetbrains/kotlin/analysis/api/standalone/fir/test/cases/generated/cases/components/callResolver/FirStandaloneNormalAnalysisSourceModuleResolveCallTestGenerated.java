...
public class FirStandaloneNormalAnalysisSourceModuleResolveCallTestGenerated extends AbstractResolveCallTest {
    ...
    public class InkonstidCode {
        ...
        public void testAllFilesPresentInInkonstidCode() throws Exception {
            KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/components/callResolver/resolveCall/inkonstidCode"), Pattern.compile("^(.+)\\.kt$"), null, true, "withTestCompilerPluginEnabled");
        }
